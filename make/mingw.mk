...
PLOS_DEFINE += -DPL_BUILD_$(PL_BUILD_ARCH)
...
#mingw_nt
PLOS_DEFINE += -DPL_BUILD_WIN32 -DPL_BUILD_MINGW32
endif
ifeq ($(PL_SYSTEM_MINGW64),true)
PLOS_DEFINE += -DPL_BUILD_WIN64 -DPL_BUILD_MINGW64
endif
ifeq ($(PL_SYSTEM_MSVC32),true)
PLOS_DEFINE += -DPL_BUILD_WIN32 -DPL_BUILD_MSVC32
endif
ifeq ($(PL_SYSTEM_MSVC64),true)
PLOS_DEFINE += -DPL_BUILD_WIN64 -DPL_BUILD_MSVC64
endif
#
PLBASE = $(BASE_ROOT)
#
