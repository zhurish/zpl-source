...
/*	reinstall_node(CONFIG_NODE, ssh_write_config);
	...
	install_element (CONFIG_NODE, &ssh_service_enable_cmd);
	install_element (CONFIG_NODE, &no_ssh_service_enable_cmd);
	install_element (CONFIG_NODE, &sftp_service_enable_cmd);
	install_element (CONFIG_NODE, &no_sftp_service_enable_cmd);
	//install_element (CONFIG_NODE, &ssh_bind_port_cmd);

	install_element (CONFIG_NODE, &ssh_bind_address_cmd);
	install_element (CONFIG_NODE, &ssh_bind_address_port_cmd);
	install_element (CONFIG_NODE, &ssh_bind_port_cmd);

	install_element (CONFIG_NODE, &ssh_login_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_login_set_cmd);

	install_element (CONFIG_NODE, &ssh_version_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_version_set_cmd);

	install_element (CONFIG_NODE, &ssh_authentication_type_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_authentication_type_set_cmd);

	install_element (CONFIG_NODE, &ssh_authentication_retries_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_authentication_retries_set_cmd);

	install_element (CONFIG_NODE, &ssh_key_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_key_set_cmd);

	install_element (CONFIG_NODE, &ssh_key_generate_cmd);
	install_element (CONFIG_NODE, &no_ssh_key_generate_cmd);

	install_element (CONFIG_NODE, &ssh_key_import_cmd);
	install_element (CONFIG_NODE, &ssh_key_export_cmd);


	install_element (ENABLE_NODE, &ssh_debug_set_cmd);
	install_element (ENABLE_NODE, &no_ssh_debug_set_cmd);
	install_element (CONFIG_NODE, &ssh_debug_set_cmd);
	install_element (CONFIG_NODE, &no_ssh_debug_set_cmd);

	install_element (ENABLE_NODE, &show_ssh_keys_cmd);
	install_element (CONFIG_NODE, &show_ssh_keys_cmd);
