...
{
	  install_element (CONFIG_NODE, &dos_icmp_long_ping_enable_cmd);
	  install_element (CONFIG_NODE, &no_dos_icmp_long_ping_enable_cmd);
	  install_element (CONFIG_NODE, &dos_frag_ment_enable_cmd);
	  install_element (CONFIG_NODE, &no_dos_frag_ment_enable_cmd);
	  ...
	  install_element (CONFIG_NODE, &no_dos_blat_enable_cmd);
	  install_element (CONFIG_NODE, &dos_lan_drip_enable_cmd);
	  install_element (CONFIG_NODE, &no_dos_lan_drip_enable_cmd);
	  install_element (CONFIG_NODE, &dos_icmp_size_enable_cmd);
	  install_element (CONFIG_NODE, &no_dos_icmp_size_enable_cmd);
	  install_element (CONFIG_NODE, &dos_tcp_hdr_size_enable_cmd);
	  install_element (CONFIG_NODE, &no_dos_tcp_hdr_size_enable_cmd);
}
