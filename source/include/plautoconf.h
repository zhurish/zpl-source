...
#define ZPL_PJPROJECT_MODULE 1
#define ZPL_PJPROJECT_OPTIONS 1
#undef ZPL_PJ_RESAMPLE_ENABLE
#define ZPL_PJ_SIMPLE_ENABLE 1
#undef ZPL_PJ_SRTP_ENABLE
#define ZPL_PJ_VIDEO_ENABLE 1
#define ZPL_PJ_VIDEO_YUV_ENABLE 1
#undef ZPL_PJ_VIDEO_H264_ENABLE
#define ZPL_PJ_CODEC_H264_LIB_PATH ""
#define ZPL_PJ_CODEC_GSM_ENABLE 1
#define ZPL_PJ_CODEC_SPEEX_ENABLE 1
#define ZPL_PJ_CODEC_ILBC_ENABLE 1
#define ZPL_PJ_CODEC_G722_ENABLE 1
