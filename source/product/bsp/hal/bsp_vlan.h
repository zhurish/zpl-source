...
typedef struct sdk_vlan_s
{
    ...
    int    (*sdk_port_allowed_tag_vlan_range)(void *, zpl_bool, zpl_phyport_t *, int, vlan_t);
    int    (*sdk_port_allowed_untag_vlan_range)(void *, zpl_bool, zpl_phyport_t *, int, vlan_t);
