...
if test "xlib" == "x$1" ;then
    ./configure --prefix=${INSTALL_DIR}/_install --enable-shared --disable-install-examples --without-curses --disable-bracketed-paste-default --disable-largefile --host=${RUNHOST} CC="${COMPILER}"
    make all
fi
