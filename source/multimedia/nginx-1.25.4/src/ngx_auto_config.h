#define NGX_CONFIGURE " --prefix=/home/zhurish/Downloads/nginx-1.25.4/_install --with-select_module --with-poll_module --with-threads --with-file-aio --without-quic_bpf_module --without-pcre --without-http_rewrite_module --add-module=./nginx-rtmp-module --with-stream --with-stream_ssl_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/zhurish/Downloads/nginx-1.25.4/_install/"
#endif
