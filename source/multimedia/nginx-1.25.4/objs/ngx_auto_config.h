#define NGX_CONFIGURE " --prefix=/home/zhurish/Downloads/nginx-1.25.4/_install --with-select_module --with-poll_module --with-threads --with-file-aio --without-quic_bpf_module --without-pcre --without-http_rewrite_module --add-module=./nginx-rtmp-module"
