 ...
 */
#ifndef ORTP_CRYPTO_H
#define ORTP_CRYPTO_H
 ...
 */
#define ORTP_DHM_UNSET				0x00000000
#define ORTP_DHM_2048				0x00000001
#define ORTP_DHM_3072				0x00000002
#define ORTP_ECDH_X25519			0x00000004
#define ORTP_ECDH_X448				0x00000008
#define ORTP_KEM_KYBER512			0x00000010
#define ORTP_KEM_KYBER768			0x00000020
#define ORTP_KEM_KYBER1024			0x00000040
#define ORTP_KEM_HQC128			0x00000080
#define ORTP_KEM_HQC192			0x00000100
#define ORTP_KEM_HQC256			0x00000200
#define ORTP_KEM_X25519			0x00000400
#define ORTP_KEM_X448				0x00000800


/* EdDSA defines */
#define ORTP_EDDSA_UNSET	0
#define ORTP_EDDSA_25519	1
#define ORTP_EDDSA_448		2

#define ORTP_VERIFY_SUCCESS	0
#define ORTP_VERIFY_FAILED	-1
...
#define ORTP_ECDH_X25519_PUBLIC_SIZE	32
#define ORTP_ECDH_X25519_PRIVATE_SIZE	ORTP_ECDH_X25519_PUBLIC_SIZE
#define ORTP_ECDH_X448_PUBLIC_SIZE	56
#define ORTP_ECDH_X448_PRIVATE_SIZE	ORTP_ECDH_X448_PUBLIC_SIZE

#define ORTP_EDDSA_25519_PUBLIC_SIZE	32
#define ORTP_EDDSA_25519_PRIVATE_SIZE	ORTP_EDDSA_25519_PUBLIC_SIZE
#define ORTP_EDDSA_25519_SIGNATURE_SIZE	(ORTP_EDDSA_25519_PUBLIC_SIZE + ORTP_EDDSA_25519_PRIVATE_SIZE)
#define ORTP_EDDSA_448_PUBLIC_SIZE	57
#define ORTP_EDDSA_448_PRIVATE_SIZE	ORTP_EDDSA_448_PUBLIC_SIZE
#define ORTP_EDDSA_448_SIGNATURE_SIZE	(ORTP_EDDSA_448_PUBLIC_SIZE + ORTP_EDDSA_448_PRIVATE_SIZE)


/* SSL settings defines */
#define ORTP_SSL_UNSET -1

#define ORTP_SSL_IS_CLIENT 0
#define ORTP_SSL_IS_SERVER 1

#define ORTP_SSL_TRANSPORT_STREAM 0
#define ORTP_SSL_TRANSPORT_DATAGRAM 1

#define ORTP_SSL_VERIFY_NONE 0
#define ORTP_SSL_VERIFY_OPTIONAL 1
#define ORTP_SSL_VERIFY_REQUIRED 2

/* Encryption/decryption defines */
#define ORTP_GCM_ENCRYPT     1
#define ORTP_GCM_DECRYPT     0
...
#define ORTP_ERROR_UNSPECIFIED_ERROR			-0x70000000
#define ORTP_ERROR_OUTPUT_BUFFER_TOO_SMALL		-0x70001000
#define ORTP_ERROR_INVALID_BASE64_INPUT		-0x70002000
#define ORTP_ERROR_INVALID_INPUT_DATA			-0x70004000
#define ORTP_ERROR_UNAVAILABLE_FUNCTION		-0x70008000

/* key related */
#define ORTP_ERROR_UNABLE_TO_PARSE_KEY		-0x70010000

/* Certificate related */
#define ORTP_ERROR_INVALID_CERTIFICATE			-0x70020000
#define ORTP_ERROR_CERTIFICATE_GENERATION_FAIL	-0x70020001
#define ORTP_ERROR_CERTIFICATE_WRITE_PEM		-0x70020002
#define ORTP_ERROR_CERTIFICATE_PARSE_PEM		-0x70020004
#define ORTP_ERROR_UNSUPPORTED_HASH_FUNCTION	-0x70020008

/* SSL related */
#define ORTP_ERROR_NET_CONN_RESET		-0x70030000
#define ORTP_ERROR_INVALID_SSL_CONFIG		-0x70030001
#define ORTP_ERROR_INVALID_SSL_TRANSPORT	-0x70030002
#define ORTP_ERROR_INVALID_SSL_ENDPOINT	-0x70030004
#define ORTP_ERROR_INVALID_SSL_AUTHMODE	-0x70030008
#define ORTP_ERROR_INVALID_SSL_CONTEXT		-0x70030010

#define ORTP_ERROR_NO_CLIENT_CERTIFICATE	-0x70031000
#define ORTP_ERROR_NET_WANT_READ		-0x70032000
#define ORTP_ERROR_NET_WANT_WRITE		-0x70034000
#define ORTP_ERROR_SSL_PEER_CLOSE_NOTIFY	-0x70038000

/* Symmetric ciphers related */
#define ORTP_ERROR_AUTHENTICATION_FAILED	-0x70040000

/* certificate verification flags codes */
#define ORTP_CERTIFICATE_VERIFY_ALL_FLAGS				0xFFFFFFFF
#define ORTP_CERTIFICATE_VERIFY_BADCERT_EXPIRED		0x01  /**< The certificate validity has expired. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_REVOKED		0x02  /**< The certificate has been revoked (is on a CRL). */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_CN_MISMATCH	0x04  /**< The certificate Common Name (CN) does not match with the expected CN. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_NOT_TRUSTED	0x08  /**< The certificate is not correctly signed by the trusted CA. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_MISSING		0x10  /**< Certificate was missing. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_SKIP_VERIFY	0x20  /**< Certificate verification was skipped. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_OTHER			0x0100  /**< Other reason (can be used by verify callback) */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_FUTURE			0x0200  /**< The certificate validity starts in the future. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_KEY_USAGE      0x0400  /**< Usage does not match the keyUsage extension. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_EXT_KEY_USAGE  0x0800  /**< Usage does not match the extendedKeyUsage extension. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_NS_CERT_TYPE   0x1000  /**< Usage does not match the nsCertType extension. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_BAD_MD         0x2000  /**< The certificate is signed with an unacceptable hash. */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_BAD_PK         0x4000  /**< The certificate is signed with an unacceptable PK alg (eg RSA vs ECDSA). */
#define ORTP_CERTIFICATE_VERIFY_BADCERT_BAD_KEY        0x8000  /**< The certificate is signed with an unacceptable key (eg bad curve, RSA too short). */

#define ORTP_CERTIFICATE_VERIFY_BADCRL_FUTURE			0x10000  /**< The CRL is from the future */
#define ORTP_CERTIFICATE_VERIFY_BADCRL_NOT_TRUSTED		0x20000  /**< CRL is not correctly signed by the trusted CA. */
#define ORTP_CERTIFICATE_VERIFY_BADCRL_EXPIRED			0x40000  /**< CRL is expired. */
#define ORTP_CERTIFICATE_VERIFY_BADCRL_BAD_MD          0x80000  /**< The CRL is signed with an unacceptable hash. */
#define ORTP_CERTIFICATE_VERIFY_BADCRL_BAD_PK          0x100000  /**< The CRL is signed with an unacceptable PK alg (eg RSA vs ECDSA). */
#define ORTP_CERTIFICATE_VERIFY_BADCRL_BAD_KEY         0x200000  /**< The CRL is signed with an unacceptable key (eg bad curve, RSA too short). */


/* Hash functions type */
typedef enum ortp_md_type {
	ORTP_MD_UNDEFINED,
	ORTP_MD_SHA1,
	ORTP_MD_SHA224,
	ORTP_MD_SHA256,
	ORTP_MD_SHA384,
	ORTP_MD_SHA512} ortp_md_type_t;

/* Dtls srtp protection profile */
typedef enum ortp_srtp_profile {
	ORTP_SRTP_UNDEFINED,
	ORTP_SRTP_AES128_CM_HMAC_SHA1_80,
	ORTP_SRTP_AES128_CM_HMAC_SHA1_32,
	ORTP_SRTP_NULL_HMAC_SHA1_80,
	ORTP_SRTP_NULL_HMAC_SHA1_32
} ortp_dtls_srtp_profile_t;

typedef enum ortp_type_implementation {
	ORTP_POLARSSL,
	ORTP_POLARSSL1_2,
	ORTP_MBEDTLS
} ortp_type_implementation_t;
 ...
 */
ORTP_PUBLIC void ortp_strerror(int32_t error_code, char *buffer, size_t buffer_length);
 ...
 *
 * @return 0 if success or ORTP_ERROR_OUTPUT_BUFFER_TOO_SMALL if the output buffer cannot contain the encoded data
 *
 * @note If the function is called with *output_length=0, set the requested buffer size in output_length
 */
ORTP_PUBLIC int32_t ortp_base64_encode(unsigned char *output, size_t *output_length, const unsigned char *input, size_t input_length);
 ...
 *
 * @return 0 if success, ORTP_ERROR_OUTPUT_BUFFER_TOO_SMALL if the output buffer cannot contain the decoded data
 * or ORTP_ERROR_INVALID_BASE64_INPUT if encoded buffer was incorrect base64 data
 *
 * @note If the function is called with *output_length=0, set the requested buffer size in output_length
 */
ORTP_PUBLIC int32_t ortp_base64_decode(unsigned char *output, size_t *output_length, const unsigned char *input, size_t input_length);

/*****************************************************************************/
/****** Random Number Generation                                        ******/
/*****************************************************************************/
/** @brief An opaque structure used to store RNG context
 * Instanciate pointers only and allocate them using the ortp_rng_context_new() function
 */
typedef struct ortp_rng_context_struct ortp_rng_context_t;

/**
 * @brief Create and initialise the Random Number Generator context
 * @return a pointer to the RNG context
 */
ORTP_PUBLIC ortp_rng_context_t *ortp_rng_context_new(void);
 ...
 * @return 0 on success
 */
ORTP_PUBLIC int32_t ortp_rng_get(ortp_rng_context_t *context, unsigned char*output, size_t output_length);
 ...
 */
ORTP_PUBLIC void ortp_rng_context_free(ortp_rng_context_t *context);

/*****************************************************************************/
/***** Signing key                                                       *****/
/*****************************************************************************/
/** @brief An opaque structure used to store the signing key context
 * Instanciate pointers only and allocate them using the ortp_signing_key_new() function
 */
typedef struct ortp_signing_key_struct ortp_signing_key_t;

/**
 * @brief Create and initialise a signing key context
 * @return a pointer to the signing key context
 */
ORTP_PUBLIC ortp_signing_key_t *ortp_signing_key_new(void);
 ...
 */
ORTP_PUBLIC void  ortp_signing_key_free(ortp_signing_key_t *key);
 ...
 */
ORTP_PUBLIC char *ortp_signing_key_get_pem(ortp_signing_key_t *key);
 ...
 * @return 0 on success
 */
ORTP_PUBLIC int32_t ortp_signing_key_parse(ortp_signing_key_t *key, const char *buffer, size_t buffer_length, const unsigned char *password, size_t password_length);
 ...
 * @return 0 on success
 */
ORTP_PUBLIC int32_t ortp_signing_key_parse_file(ortp_signing_key_t *key, const char *path, const char *password);

/*****************************************************************************/
/***** X509 Certificate                                                  *****/
/*****************************************************************************/
/** @brief An opaque structure used to store the certificate context
 * Instanciate pointers only and allocate them using the ortp_x509_certificate_new() function
 */
typedef struct ortp_x509_certificate_struct ortp_x509_certificate_t;

/**
 * @brief Create and initialise a x509 certificate context
 * @return a pointer to the certificate context
 */
ORTP_PUBLIC ortp_x509_certificate_t *ortp_x509_certificate_new(void);
 ...
 */
ORTP_PUBLIC void  ortp_x509_certificate_free(ortp_x509_certificate_t *cert);
 ...
 */
ORTP_PUBLIC char *ortp_x509_certificates_chain_get_pem(const ortp_x509_certificate_t *cert);
 ...
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_info_string(char *buf, size_t size, const char *prefix, const ortp_x509_certificate_t *cert);
 ...
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_parse(ortp_x509_certificate_t *cert, const char *buffer, size_t buffer_length);
 ...
 * @return	0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_parse_file(ortp_x509_certificate_t *cert, const char *path);
 ...
 * @return	0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_parse_path(ortp_x509_certificate_t *cert, const char *path);
 ...
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_der_length(ortp_x509_certificate_t *cert);
 ...
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_der(ortp_x509_certificate_t *cert, unsigned char *buffer, size_t buffer_length);
 ...
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_subject_dn(const ortp_x509_certificate_t *cert, char *dn, size_t dn_length);

/**
 * @brief Obtain the certificate subjects (all subjectAltName URIS and DNS + subject CN)
 *
 * @param[in]		cert		The x509 certificate
 * @return a list of allocated strings (char*), to be freed with ortp_free()
 */
ORTP_PUBLIC ortp_list_t *ortp_x509_certificate_get_subjects(const ortp_x509_certificate_t *cert);
 ...
 * @param[in]		hash_algorithm		set to ORTP_MD_UNDEFINED to use the hash used in certificate signature(recommended)
 *						or specify an other hash algorithm(ORTP_MD_SHA1, ORTP_MD_SHA224, ORTP_MD_SHA256, ORTP_MD_SHA384, ORTP_MD_SHA512)
 * @return length of written on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_fingerprint(const ortp_x509_certificate_t *cert, char *fingerprint, size_t fingerprint_length, ortp_md_type_t hash_algorithm);

/**
 * @brief Retrieve the certificate signature hash function
 *
 * @param[in]	cert		The x509 certificate
 * @param[out]	hash_algorithm	The hash algorithm used for the certificate signature or ORTP_MD_UNDEFINED if unable to retrieve it
 *
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_get_signature_hash_function(const ortp_x509_certificate_t *certificate, ortp_md_type_t *hash_algorithm);
 ...
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_generate_selfsigned(const char *subject, ortp_x509_certificate_t *certificate, ortp_signing_key_t *pkey, char *pem, size_t pem_length);
 ...
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_flags_to_string(char *buffer, size_t buffer_size, uint32_t flags);
 ...
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_set_flag(uint32_t *flags, uint32_t flags_to_set);
 ...
 */
ORTP_PUBLIC uint32_t ortp_x509_certificate_remap_flag(uint32_t flags);
 ...
 * @return 0 on success, negative error code otherwise
 */
ORTP_PUBLIC int32_t ortp_x509_certificate_unset_flag(uint32_t *flags, uint32_t flags_to_unset);


/*****************************************************************************/
/***** SSL                                                               *****/
/*****************************************************************************/
typedef struct ortp_ssl_context_struct ortp_ssl_context_t;
typedef struct ortp_ssl_config_struct ortp_ssl_config_t;
ORTP_PUBLIC ortp_type_implementation_t ortp_ssl_get_implementation_type(void);
ORTP_PUBLIC ortp_ssl_context_t *ortp_ssl_context_new(void);
ORTP_PUBLIC void ortp_ssl_context_free(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int32_t ortp_ssl_context_setup(ortp_ssl_context_t *ssl_ctx, ortp_ssl_config_t *ssl_config);

ORTP_PUBLIC int32_t ortp_ssl_close_notify(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int32_t ortp_ssl_session_reset(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int32_t ortp_ssl_read(ortp_ssl_context_t *ssl_ctx, unsigned char *buf, size_t buf_length);
ORTP_PUBLIC int32_t ortp_ssl_write(ortp_ssl_context_t *ssl_ctx, const unsigned char *buf, size_t buf_length);
ORTP_PUBLIC int32_t ortp_ssl_set_hostname(ortp_ssl_context_t *ssl_ctx, const char *hostname);
ORTP_PUBLIC int32_t ortp_ssl_handshake(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int32_t ortp_ssl_set_hs_own_cert(ortp_ssl_context_t *ssl_ctx, ortp_x509_certificate_t *cert, ortp_signing_key_t *key);
ORTP_PUBLIC void ortp_ssl_set_io_callbacks(ortp_ssl_context_t *ssl_ctx, void *callback_data,
...
ORTP_PUBLIC const ortp_x509_certificate_t *ortp_ssl_get_peer_certificate(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC const char *ortp_ssl_get_ciphersuite(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int ortp_ssl_get_ciphersuite_id(const char* ciphersuite);
ORTP_PUBLIC const char *ortp_ssl_get_version(ortp_ssl_context_t *ssl_ctx);
	
ORTP_PUBLIC ortp_ssl_config_t *ortp_ssl_config_new(void);
ORTP_PUBLIC int32_t ortp_ssl_config_set_crypto_library_config(ortp_ssl_config_t *ssl_config, void *internal_config);
ORTP_PUBLIC void ortp_ssl_config_free(ortp_ssl_config_t *ssl_config);
ORTP_PUBLIC void *ortp_ssl_config_get_private_config(ortp_ssl_config_t *ssl_config);
ORTP_PUBLIC int32_t ortp_ssl_config_defaults(ortp_ssl_config_t *ssl_config, int endpoint, int transport);
ORTP_PUBLIC int32_t ortp_ssl_config_set_endpoint(ortp_ssl_config_t *ssl_config, int endpoint);
ORTP_PUBLIC int32_t ortp_ssl_config_set_transport (ortp_ssl_config_t *ssl_config, int transport);
ORTP_PUBLIC int32_t ortp_ssl_config_set_authmode(ortp_ssl_config_t *ssl_config, int authmode);
ORTP_PUBLIC int32_t ortp_ssl_config_set_rng(ortp_ssl_config_t *ssl_config, int(*rng_function)(void *, unsigned char *, size_t), void *rng_context);
ORTP_PUBLIC int32_t ortp_ssl_config_set_callback_verify(ortp_ssl_config_t *ssl_config, int(*callback_function)(void *, ortp_x509_certificate_t *, int, uint32_t *), void *callback_data);
ORTP_PUBLIC int32_t ortp_ssl_config_set_callback_cli_cert(ortp_ssl_config_t *ssl_config, int(*callback_function)(void *, ortp_ssl_context_t *, const ortp_list_t *), void *callback_data);
ORTP_PUBLIC int32_t ortp_ssl_config_set_ca_chain(ortp_ssl_config_t *ssl_config, ortp_x509_certificate_t *ca_chain);
ORTP_PUBLIC int32_t ortp_ssl_config_set_own_cert(ortp_ssl_config_t *ssl_config, ortp_x509_certificate_t *cert, ortp_signing_key_t *key);
ORTP_PUBLIC int32_t ortp_ssl_config_set_ciphersuites(ortp_ssl_config_t *ssl_config,const int *ciphersuites);
	
/***** DTLS-SRTP functions *****/
ORTP_PUBLIC ortp_dtls_srtp_profile_t ortp_ssl_get_dtls_srtp_protection_profile(ortp_ssl_context_t *ssl_ctx);
ORTP_PUBLIC int32_t ortp_ssl_config_set_dtls_srtp_protection_profiles(ortp_ssl_config_t *ssl_config, const ortp_dtls_srtp_profile_t *profiles, size_t profiles_number);
ORTP_PUBLIC int32_t ortp_ssl_get_dtls_srtp_key_material(ortp_ssl_config_t *ssl_ctx, uint8_t *output, size_t *output_length);
ORTP_PUBLIC uint8_t ortp_dtls_srtp_supported(void);
ORTP_PUBLIC void ortp_ssl_set_mtu(ortp_ssl_context_t *ssl_ctx, uint16_t mtu);
 ...
 */
ORTP_PUBLIC uint32_t ortp_key_agreement_algo_list(void);
 ...
 */
typedef struct ortp_DHMContext_struct {
	uint8_t algo; /**< Algorithm used for the key exchange mapped to an int: ORTP_DHM_2048, ORTP_DHM_3072 */
 ...
 *
 * @param[in] DHMAlgo		The algorithm type(ORTP_DHM_2048 or ORTP_DHM_3072)
 ...
 *
 */
ORTP_PUBLIC ortp_DHMContext_t *ortp_CreateDHMContext(uint8_t DHMAlgo, uint8_t secretLength);
 ...
 *
 */
ORTP_PUBLIC void ortp_DHMCreatePublic(ortp_DHMContext_t *context, int (*rngFunction)(void *, uint8_t *, size_t), void *rngContext);
 ...
 *
 */
ORTP_PUBLIC void ortp_DHMComputeSecret(ortp_DHMContext_t *context, int (*rngFunction)(void *, uint8_t *, size_t), void *rngContext);
 ...
 *
 */
ORTP_PUBLIC void ortp_DestroyDHMContext(ortp_DHMContext_t *context);
 ...
 */
ORTP_PUBLIC int ortp_crypto_have_ecc(void);

/**
 * @brief Context for the EC Diffie-Hellman-Merkle key exchange on curve 25519 and 448
 *	Use RFC7748 for base points values
 */
typedef struct ortp_ECDHContext_struct {
	uint8_t algo; /**< Algorithm used for the key exchange mapped to an int: ORTP_ECDH_X25519, ORTP_ECDH_X448 */
 ...
 *
 * @param[in] ECDHAlgo		The algorithm type(ORTP_ECDH_X25519 or ORTP_ECDH_X448)
 *
 ...
 *
 */
ORTP_PUBLIC ortp_ECDHContext_t *ortp_CreateECDHContext(const uint8_t ECDHAlgo);
 ...
 *
 */
ORTP_PUBLIC void ortp_ECDHCreateKeyPair(ortp_ECDHContext_t *context, int (*rngFunction)(void *, uint8_t *, size_t), void *rngContext);
 ...
 */
ORTP_PUBLIC void ortp_ECDHSetSecretKey(ortp_ECDHContext_t *context, const uint8_t *secret, const size_t secretLength);
 ...
 */
ORTP_PUBLIC void ortp_ECDHSetSelfPublicKey(ortp_ECDHContext_t *context, const uint8_t *selfPublic, const size_t selfPublicLength);
 ...
 */
ORTP_PUBLIC void ortp_ECDHSetPeerPublicKey(ortp_ECDHContext_t *context, const uint8_t *peerPublic, const size_t peerPublicLength);
 ...
 */
ORTP_PUBLIC void ortp_ECDHDerivePublicKey(ortp_ECDHContext_t *context);
 ...
 *
 */
ORTP_PUBLIC void ortp_ECDHComputeSecret(ortp_ECDHContext_t *context, int (*rngFunction)(void *, uint8_t *, size_t), void *rngContext);
 ...
 *
 */
ORTP_PUBLIC void ortp_DestroyECDHContext(ortp_ECDHContext_t *context);
 ...
 */
typedef struct ortp_EDDSAContext_struct {
	uint8_t algo; /**< Algorithm used for the key exchange mapped to an int: ORTP_EDDSA_25519, ORTP_EDDSA_448 */
 ...
 *
 * @param[in] EDDSAAlgo		The algorithm type(ORTP_EDDSA_25519 or ORTP_EDDSA_448)
 *
 ...
 *
 */
ORTP_PUBLIC ortp_EDDSAContext_t *ortp_CreateEDDSAContext(uint8_t EDDSAAlgo);
 ...
 *
 */
ORTP_PUBLIC void ortp_EDDSACreateKeyPair(ortp_EDDSAContext_t *context, int (*rngFunction)(void *, uint8_t *, size_t), void *rngContext);
 ...
 *
 */
ORTP_PUBLIC void ortp_EDDSADerivePublicKey(ortp_EDDSAContext_t *context);
 ...
 *
 */
ORTP_PUBLIC void ortp_DestroyEDDSAContext(ortp_EDDSAContext_t *context);
 ...
 *
 */
ORTP_PUBLIC void ortp_EDDSA_sign(ortp_EDDSAContext_t *context, const uint8_t *message, const size_t messageLength, const uint8_t *AssociatedData, const uint8_t associatedDataLength, uint8_t *signature, size_t *signatureLength);
 ...
 */
ORTP_PUBLIC void ortp_EDDSA_setPublicKey(ortp_EDDSAContext_t *context, const uint8_t *publicKey, const size_t publicKeyLength);
 ...
 */
ORTP_PUBLIC void ortp_EDDSA_setSecretKey(ortp_EDDSAContext_t *context, const uint8_t *secretKey, const size_t secretKeyLength);
 ...
 *
 * @return ORTP_VERIFY_SUCCESS or ORTP_VERIFY_FAILED
 */
ORTP_PUBLIC int ortp_EDDSA_verify(ortp_EDDSAContext_t *context, const uint8_t *message, size_t messageLength, const uint8_t *associatedData, const uint8_t associatedDataLength, const uint8_t *signature, size_t signatureLength);
...
*/
ORTP_PUBLIC void ortp_EDDSA_ECDH_privateKeyConversion(const ortp_EDDSAContext_t *ed, ortp_ECDHContext_t *x);

#define ORTP_ECDH_ISPEER	0
#define ORTP_ECDH_ISSELF	1
 ...
 * @param[in]	isSelf	Flag to decide where to store the public key in context: ORTP_ECDH_ISPEER or ORTP_ECDH_ISPEER
*/
ORTP_PUBLIC void ortp_EDDSA_ECDH_publicKeyConversion(const ortp_EDDSAContext_t *ed, ortp_ECDHContext_t *x, uint8_t isSelf);
 ...
 *
 */
ORTP_PUBLIC void ortp_sha512(const uint8_t *input,
		size_t inputLength,
		uint8_t hashLength,
		uint8_t *output);
 ...
 *
 */
ORTP_PUBLIC void ortp_sha384(const uint8_t *input,
		size_t inputLength,
		uint8_t hashLength,
		uint8_t *output);
/**
 ...
 *
 */
ORTP_PUBLIC void ortp_sha256(const uint8_t *input,
		size_t inputLength,
		uint8_t hashLength,
		uint8_t *output);
 ...
 *
 */
ORTP_PUBLIC void ortp_hmacSha512(const uint8_t *key,
		size_t keyLength,
		const uint8_t *input,
		size_t inputLength,
		uint8_t hmacLength,
 ...
 *
 */
ORTP_PUBLIC void ortp_hmacSha384(const uint8_t *key,
		size_t keyLength,
		const uint8_t *input,
		size_t inputLength,
		uint8_t hmacLength,
 ...
 *
 */
ORTP_PUBLIC void ortp_hmacSha256(const uint8_t *key,
		size_t keyLength,
		const uint8_t *input,
		size_t inputLength,
		uint8_t hmacLength,
 ...
 *
 */
ORTP_PUBLIC void ortp_hmacSha1(const uint8_t *key,
		size_t keyLength,
		const uint8_t *input,
		size_t inputLength,
		uint8_t hmacLength,
 ...
 *
 */
ORTP_PUBLIC void ortp_md5(const uint8_t *input,
		size_t inputLength,
		uint8_t output[16]);
...
/*****************************************************************************/
typedef struct ortp_aes_gcm_context_struct ortp_aes_gcm_context_t;
/**
 ...
 */
ORTP_PUBLIC int32_t ortp_aes_gcm_encrypt_and_tag(const uint8_t *key, size_t keyLength,
 ...
 *
 * @return 0 on succes, ORTP_ERROR_AUTHENTICATION_FAILED if tag doesn't match or crypto library error code
 */
ORTP_PUBLIC int32_t ortp_aes_gcm_decrypt_and_auth(const uint8_t *key, size_t keyLength,
 ...
 *
 * @return a pointer to the created context, to be freed using ortp_aes_gcm_finish()
 */
ORTP_PUBLIC ortp_aes_gcm_context_t *ortp_aes_gcm_context_new(const uint8_t *key, size_t keyLength,
		const uint8_t *authenticatedData, size_t authenticatedDataLength,
		const uint8_t *initializationVector, size_t initializationVectorLength,
		uint8_t mode);
 ...
 * @return 0 on success, crypto library error code otherwise
 */
ORTP_PUBLIC int32_t ortp_aes_gcm_process_chunk(ortp_aes_gcm_context_t *context,
 ...
 * @return 0 on success, crypto library error code otherwise
 */
ORTP_PUBLIC int32_t ortp_aes_gcm_finish(ortp_aes_gcm_context_t *context,
		uint8_t *tag, size_t tagLength);
 ...
 *
 */
ORTP_PUBLIC void ortp_aes128CfbEncrypt(const uint8_t *key,
		const uint8_t *IV,
		const uint8_t *input,
		size_t inputLength,
		uint8_t *output);
 ...
 *
 */
ORTP_PUBLIC void ortp_aes128CfbDecrypt(const uint8_t *key,
		const uint8_t *IV,
		const uint8_t *input,
		size_t inputLength,
		uint8_t *output);
 ...
 *
 */
ORTP_PUBLIC void ortp_aes256CfbEncrypt(const uint8_t *key,
		const uint8_t *IV,
		const uint8_t *input,
		size_t inputLength,
		uint8_t *output);
 ...
 *
 */
ORTP_PUBLIC void ortp_aes256CfbDecrypt(const uint8_t *key,
		const uint8_t *IV,
		const uint8_t *input,
		size_t inputLength,
		uint8_t *output);
 ...
 *
 * @param[in/out]	cryptoContext	a context already initialized using ortp_aes_gcm_context_new (created if NULL)
 * @param[in]		key		encryption key
 ...
 */
ORTP_PUBLIC int ortp_aes_gcm_encryptFile(void **cryptoContext, unsigned char *key, size_t length, char *plain, char *cipher);
 ...
 *
 * @param[in/out]	cryptoContext	a context already initialized using ortp_aes_gcm_context_new
 * @param[in]		key		encryption key
 ...
 */
ORTP_PUBLIC int ortp_aes_gcm_decryptFile(void **cryptoContext, unsigned char *key, size_t length, char *plain, char *cipher);
 ...
 */
ORTP_PUBLIC void ortp_clean(void *buffer, size_t size);
