...
#define RTP_DEFAULT_JITTER_TIME 20	/*miliseconds*/
#define RTP_DEFAULT_MULTICAST_TTL 5	/*hops*/
#define RTP_DEFAULT_MULTICAST_LOOPBACK 0  /*false*/
#define RTP_DEFAULT_DSCP 0x38  /*best effort*/
#define SRTP_MAX_TRAILER_LEN    128


#ifndef MAX_RTP_PAYLOAD_LENGTH
#  if RTP_HAS_SRTP
#     define MAX_RTP_PAYLOAD_LENGTH     (UDP_MAX_SIZE - IPMAXLEN - (128+16) RTP_FIXED_HEADER_SIZE - 8)
#  else
#     define MAX_RTP_PAYLOAD_LENGTH     1400//(UDP_MAX_SIZE - IPMAXLEN - RTP_FIXED_HEADER_SIZE - 8)
#  endif
#endif

//#define MAX_RTP_PAYLOAD_LENGTH (UDP_MAX_SIZE-IPMAXLEN-RTP_FIXED_HEADER_SIZE-5)
