...
#ifndef ORTP_CRYPTO_HH
#define ORTP_CRYPTO_HH
 ...
 *
 * @return 0 if no problem, ORTP_ERROR_INVALID_INPUT_DATA otherwise
 */
 ...
 * @param[in]	aes_id		Id of the AES version used here
 *
 * @return 0 if no problem, {ORTP_ERROR_INVALID_INPUT_DATA, ORTP_ERROR_UNSPECIFIED_ERROR} otherwise
 */
