...
typedef struct MSZrtpParams {
	...
	ortp_mutex_t *zidCacheDBMutex; /**< pointer to a mutex used to lock cache access */
 ...
 */
MS2_PUBLIC MSZrtpPeerStatus ms_zrtp_get_peer_status(void *db, const char *peerUri, ortp_mutex_t *dbMutex);
 ...
 */
MS2_PUBLIC int ms_zrtp_initCache(void *db, ortp_mutex_t *dbMutex);
