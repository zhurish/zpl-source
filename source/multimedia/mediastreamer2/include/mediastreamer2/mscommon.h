...
static MS2_INLINE void ms_debug(const char *fmt, ...) {
	va_list args;
	va_start(args, fmt);
	ortp_logv(BCTBX_LOG_DOMAIN, BCTBX_LOG_DEBUG, fmt, args);
	va_end(args);
}
#else
#define ms_debug(fmt, ...)
...
typedef ortp_compare_func MSCompareFunc;
 ...
 * @deprecated Use ortp_list_append() instead
**/
 ...
 * @return first element of the list
 * @deprecated Use ortp_list_concat() instead
**/
 ...
 * @deprecated Use ortp_list_prepend() instead
**/
 ...
 * @return NULL
 * @deprecated Use ortp_list_free() instead
**/
 ...
 * @return NULL
 * @deprecated Use ortp_list_free_with_data() instead
**/
 ...
 * @deprecated Use ortp_list_remove() instead
**/
 ...
 * @return first element of the modified list
 * @deprecated Use ortp_list_remove_custom() instead
**/
 ...
 * @return Size of list
 * @deprecated Use ortp_list_size() instead
**/
 ...
 * @deprecated Use ortp_list_for_each() instead
**/
 ...
 * @deprecated Use ortp_list_for_each2() instead
**/
 ...
 * @return first element of the modified list
 * @deprecated Use ortp_list_remove_link() instead
**/
 ...
 * @deprecated Use ortp_list_find() instead
**/
 ...
 * @deprecated Use ortp_list_find_custom() instead
**/
 ...
 * @deprecated Use ortp_list_nth_data() instead
**/
 ...
 * @deprecated Use ortp_list_position() instead
**/
 ...
 * @deprecated Use ortp_list_index() instead
**/
 ...
 * @return first element of the list.
 * @deprecated Use ortp_list_insert_sorted() instead
**/
 ...
 * @param data data to insert into the list
 * @return first element of the modified list.
 * @deprecated Use ortp_list_insert() instead
**/
 ...
 * @deprecated Use ortp_list_copy() instead
**/
 ...
 * @return Newly created list
 * @deprecated Use ortp_list_copy_with_data() instead
**/
MS2_PUBLIC MS2_DEPRECATED MSList *ms_list_copy_with_data(const MSList *list, void *(*copyfunc)(void *));

/**
 * @deprecated @deprecated Use ortp_list_next() instead
 */
