...
static int ms_srtp_process_dummy(ORTP_UNUSED(RtpTransportModifier *t), mblk_t *m) {
...
static int ms_add_srtp_stream(srtp_t srtp, MSCryptoSuite suite, ORTP_UNUSED(uint32_t ssrc), const char *key, size_t key_length, bool_t is_send, bool_t is_rtp) {
