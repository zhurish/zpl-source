...
JNIEXPORT void JNICALL Java_org_linphone_mediastream_MediastreamerAndroidContext_addSoundDeviceDescription(JNIEnv* env, ORTP_UNUSED(jobject thiz), jstring jmanufacturer, jstring jmodel, jstring jplatform, jint flags, jint delay, jint rate) {
...
static ortp_list_t *sound_device_descriptions;
...
void ms_sound_device_description_add(const char *manufacturer, const char *model, const char *platform, unsigned int flags, int delay, int recommended_rate) {
	...
	sound_device_descriptions = ortp_list_append(sound_device_descriptions, new_sound_device_description);
}
...
void ms_devices_info_free(MSDevicesInfo *devices_info) {
	if (devices_info->sound_devices_descriptions) ortp_list_free(devices_info->sound_devices_descriptions);
...
void ms_devices_info_add(MSDevicesInfo *devices_info, const char *manufacturer, const char *model, const char *platform, unsigned int flags, int delay, int recommended_rate) {
	...
	devices_info->sound_devices_descriptions = ortp_list_append(devices_info->sound_devices_descriptions, new_sound_device_description);
}
...
SoundDeviceDescription* ms_devices_info_lookup_device(MSDevicesInfo *devices_info, const char *manufacturer, const char* model, const char *platform) {
	ortp_list_t *list = devices_info->sound_devices_descriptions;
