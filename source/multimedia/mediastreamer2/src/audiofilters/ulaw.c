...
static int get_sample_rate(ORTP_UNUSED(MSFilter *f), void *arg) {
	*((int *)arg) = 8000;
	return 0;
}

static int dec_have_plc(ORTP_UNUSED(MSFilter *f), void *arg) {
	*((int *)arg) = 0;
	return 0;
}

static int get_channels(ORTP_UNUSED(MSFilter *f), void *arg) {
	*((int *)arg) = 1;
	return 0;
}
