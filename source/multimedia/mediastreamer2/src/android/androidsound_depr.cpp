...
extern "C" {
#endif
JNIEXPORT jboolean JNICALL Java_org_linphone_mediastream_Version_nativeHasNeon(ORTP_UNUSED(JNIEnv *env), ORTP_UNUSED(jclass c)) {
...
JNIEXPORT jboolean JNICALL Java_org_linphone_mediastream_Version_nativeHasZrtp(ORTP_UNUSED(JNIEnv *env), ORTP_UNUSED(jclass c)) {
	return ms_zrtp_available();
}

JNIEXPORT jboolean JNICALL Java_org_linphone_mediastream_Version_nativeHasVideo(ORTP_UNUSED(JNIEnv *env), ORTP_UNUSED(jclass c)) {
#ifdef VIDEO_ENABLED
	return JNI_TRUE;
#else
	return JNI_FALSE;
...
void msandroid_sound_set_level(ORTP_UNUSED(MSSndCard *card), ORTP_UNUSED(MSSndCardMixerElem e), ORTP_UNUSED(int percent))
{
}

int msandroid_sound_get_level(ORTP_UNUSED(MSSndCard *card), ORTP_UNUSED(MSSndCardMixerElem e))
{
	return 0;
}

void msandroid_sound_set_source(ORTP_UNUSED(MSSndCard *card), ORTP_UNUSED(MSSndCardCapture source))
{
}

static int sdk_version=0;

void msandroid_sound_init(ORTP_UNUSED(MSSndCard *card)){
...
void msandroid_sound_uninit(ORTP_UNUSED(MSSndCard *card)){
}
