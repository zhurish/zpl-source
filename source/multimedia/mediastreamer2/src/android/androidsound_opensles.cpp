...
static void android_snd_card_add_devices(ORTP_UNUSED(MSDevicesInfo *devices), SoundDeviceDescription* deviceDescription, MSSndCardManager *m) {
...
**/
static void opensles_recorder_callback(ORTP_UNUSED(SLAndroidSimpleBufferQueueItf bq), void *context) {
	SLresult result;
...
static int android_snd_read_set_sample_rate(ORTP_UNUSED(MSFilter *obj), ORTP_UNUSED(void *data)) {
#if 0
	int *n = (int*)data;
	OpenSLESInputContext *ictx = (OpenSLESInputContext*)obj->data;
...
static int android_snd_read_hack_speaker_state(ORTP_UNUSED(MSFilter *obj), ORTP_UNUSED(void *data)) {
	return 0;
}
...
static void opensles_player_callback(ORTP_UNUSED(SLAndroidSimpleBufferQueueItf bq), void* context) {
	SLresult result;
...
static int android_snd_write_set_sample_rate(ORTP_UNUSED(MSFilter *obj), ORTP_UNUSED(void *data)) {
#if 0
	int *n = (int*)data;
	OpenSLESOutputContext *octx = (OpenSLESOutputContext*)obj->data;
...
static void snd_card_device_create_extra_fields(ORTP_UNUSED(MSSndCardManager *m), MSSndCard *card, SoundDeviceDescription *deviceDescription) {
