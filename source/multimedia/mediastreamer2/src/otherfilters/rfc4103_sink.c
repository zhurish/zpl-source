...
static void ms_rtt_4103_sink_preprocess(ORTP_UNUSED(MSFilter *f)) {
...
static void ms_rtt_4103_sink_postprocess(ORTP_UNUSED(MSFilter *f)) {
...
static int ms_rtt_4103_resync(MSFilter *f, ORTP_UNUSED(void *arg)){
	RealTimeTextSinkData *s = (RealTimeTextSinkData *)f->data;
	ms_filter_lock(f);
	s->flags = 0;
	s->prevseqno = 0;
