...
void ms_media_recorder_remove_file(ORTP_UNUSED(MSMediaRecorder *obj), const char *filepath) {
...
static void _recorder_callback(void *ud, ORTP_UNUSED(MSFilter *f), ORTP_UNUSED(unsigned int id), ORTP_UNUSED(void *arg)) {
