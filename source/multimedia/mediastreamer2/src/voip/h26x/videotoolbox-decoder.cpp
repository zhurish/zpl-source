...
void VideoToolboxDecoder::outputCb(void *decompressionOutputRefCon, ORTP_UNUSED(void *sourceFrameRefCon), OSStatus status,
								   ORTP_UNUSED(VTDecodeInfoFlags infoFlags), CVImageBufferRef imageBuffer,
								   ORTP_UNUSED(CMTime presentationTimeStamp), ORTP_UNUSED(CMTime presentationDuration)) {
