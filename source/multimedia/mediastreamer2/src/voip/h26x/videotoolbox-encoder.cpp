...
void VideoToolboxEncoder::outputCb(void *outputCallbackRefCon, ORTP_UNUSED(void *sourceFrameRefCon), OSStatus status, ORTP_UNUSED(VTEncodeInfoFlags infoFlags), CMSampleBufferRef sampleBuffer) {
