...
static void text_stream_process_rtcp(ORTP_UNUSED(MediaStream *media_stream), ORTP_UNUSED(mblk_t *m)) {
}
...
static void text_stream_ssrc_changed(ORTP_UNUSED(RtpSession *session), void *data){
	TextStream *stream = (TextStream *)data;
