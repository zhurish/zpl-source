...
static void audio_bitrate_driver_uninit(ORTP_UNUSED(MSBitrateDriver *objbase)){
...
static void bandwidth_bitrate_driver_uninit(ORTP_UNUSED(MSBitrateDriver *objbase)){
}
