...
int EncodingFilterWrapper::onRequestVfuCall(MSFilter *f, ORTP_UNUSED(void *arg)) {
	try {
...
int EncodingFilterWrapper::onNotifyPliCall(MSFilter *f, ORTP_UNUSED(void *arg)) {
	try {
...
int EncodingFilterWrapper::onNotifyFirCall(MSFilter *f, ORTP_UNUSED(void *arg)) {
	try {
