 ...
 */
ssize_t nal_hevc_write_vps(void *dest, size_t n, struct nal_hevc_vps *vps)
{
	struct rbsp rbsp;
 ...
 */
ssize_t nal_hevc_read_vps(struct nal_hevc_vps *vps, void *src, size_t n)
{
	struct rbsp rbsp;
 ...
 * Return: number of bytes written to @dest or negative error code
 */
ssize_t nal_hevc_write_sps(void *dest, size_t n, struct nal_hevc_sps *sps)
{
	struct rbsp rbsp;
	unsigned int forbidden_zero_bit = 0;
 ...
 * Return: number of bytes read from @src or negative error code
 */
ssize_t nal_hevc_read_sps(struct nal_hevc_sps *sps, void *src, size_t n)
{
	struct rbsp rbsp;
	unsigned int forbidden_zero_bit;
	unsigned int nal_unit_type;
 ...
 * Return: number of bytes written to @dest or negative error code
 */
ssize_t nal_hevc_write_pps(void *dest, size_t n, struct nal_hevc_pps *pps)
{
	struct rbsp rbsp;
	unsigned int forbidden_zero_bit = 0;
 ...
 * Return: number of bytes read from @src or negative error code
 */
ssize_t nal_hevc_read_pps(struct nal_hevc_pps *pps, void *src, size_t n)
{
	struct rbsp rbsp;
	unsigned int forbidden_zero_bit;
	unsigned int nal_unit_type;
