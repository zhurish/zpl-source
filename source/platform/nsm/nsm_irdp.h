...
#define IF_SHUTDOWN             (1<<6) 
  ...
  struct eloop *t_advertise;
  unsigned long nsm_irdp_sent;
  u_int16_t Lifetime;
...
extern int nsm_irdp_send_thread(struct eloop *t_advert);
extern void nsm_irdp_advert_off(struct interface *ifp);
extern void nsm_process_solicit (struct interface *ifp);
extern int nsm_irdp_read_raw(struct eloop *r);
extern void nsm_send_packet(struct interface *ifp, struct stream *s,
