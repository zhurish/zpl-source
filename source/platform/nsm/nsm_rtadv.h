...
#ifndef IPSTACK_ND_OPT_PI_FLAG_RADDR
#define IPSTACK_ND_OPT_PI_FLAG_RADDR         0x20
#endif

};

extern void nsm_rtadv_config_write (struct vty *, struct interface *);

/* RFC4584 Extension to Sockets API for Mobile IPv6 */

#ifndef IPSTACK_ND_OPT_ADV_INTERVAL
#define IPSTACK_ND_OPT_ADV_INTERVAL	7   /* Adv Interval Option */
#endif
#ifndef IPSTACK_ND_OPT_HA_INFORMATION
#define IPSTACK_ND_OPT_HA_INFORMATION	8   /* HA Information Option */
#endif
