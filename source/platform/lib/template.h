...
extern void lib_template_init (void);
...
extern int lib_template_write_config (struct vty *vty);
extern int lib_template_show_config (struct vty *vty, zpl_bool detail);
extern int lib_template_service_write_config (struct vty *vty);
extern int lib_template_service_show_config (struct vty *vty, zpl_bool detail);

extern int lib_template_debug_write_config (struct vty *vty);
extern int lib_template_debug_show_config (struct vty *vty, zpl_bool detail);

extern int cmd_lib_template_init(void);
#endif 
#ifdef __cplusplus
}
#endif
