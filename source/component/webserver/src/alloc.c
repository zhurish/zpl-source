...
static char         *freeBuf = NULL;                           /* Pointer to free memory */
static char         *freeNext = NULL;                          /* Pointer to next free mem */
static int          freeSize = 0;                           /* Size of free memory */
static int          freeLeft = 0;                           /* Size of free left for use */
