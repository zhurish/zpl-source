...
PUBLIC int       __websLogLevel;          /* Log verbosity level */
//#endif /* ME_GOAHEAD_LOGGING */
/************************************* Locals *********************************/

static Callback  **callbacks = NULL;
static int       callbackMax = 0;

static HashTable **sym = NULL;             /* List of symbol tables */
