...
prep:
	...
	@[ ! -f $(ZPL_BUILD)/inc/me.h ] && cp projects/goahead-linux-default-me.h $(ZPL_BUILD)/inc/me.h ; true
	@if ! diff $(ZPL_BUILD)/inc/me.h projects/goahead-linux-default-me.h >/dev/null ; then\
		cp projects/goahead-linux-default-me.h $(ZPL_BUILD)/inc/me.h  ; \
	fi; true
...
$(ZPL_BUILD)/obj/action.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/action.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/action.c
...
$(ZPL_BUILD)/obj/alloc.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/alloc.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/alloc.c
...
$(ZPL_BUILD)/obj/auth.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/auth.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/auth.c
...
$(ZPL_BUILD)/obj/cgi.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/cgi.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/cgi.c
...
$(ZPL_BUILD)/obj/cgitest.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/cgitest.o $(CFLAGS) $(DFLAGS) $(IFLAGS) test/cgitest.c
...
$(ZPL_BUILD)/obj/crypt.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/crypt.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/crypt.c
...
$(ZPL_BUILD)/obj/file.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/file.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/file.c
...
$(ZPL_BUILD)/obj/fs.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/fs.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/fs.c
...
$(ZPL_BUILD)/obj/goahead-mbedtls.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/goahead-mbedtls.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/goahead-mbedtls/goahead-mbedtls.c
...
$(ZPL_BUILD)/obj/goahead.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/goahead.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/goahead.c
...
$(ZPL_BUILD)/obj/gopass.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/gopass.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/utils/gopass.c
...
$(ZPL_BUILD)/obj/http.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/http.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/http.c
...
$(ZPL_BUILD)/obj/js.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/js.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/js.c
...
$(ZPL_BUILD)/obj/jst.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/jst.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/jst.c
...
$(ZPL_BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/mbedtls.o $(CFLAGS) $(DFLAGS) -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/mbedtls/mbedtls.c
...
$(ZPL_BUILD)/obj/options.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/options.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/options.c
...
$(ZPL_BUILD)/obj/osdep.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/osdep.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/osdep.c
...
$(ZPL_BUILD)/obj/rom.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/rom.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/rom.c
...
$(ZPL_BUILD)/obj/route.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/route.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/route.c
...
$(ZPL_BUILD)/obj/runtime.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/runtime.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/runtime.c
...
$(ZPL_BUILD)/obj/socket.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/socket.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/socket.c
...
$(ZPL_BUILD)/obj/test.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/test.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) test/test.c
...
$(ZPL_BUILD)/obj/time.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/time.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/time.c
...
$(ZPL_BUILD)/obj/upload.o: \
	...
	$(CC) -c -o $(ZPL_BUILD)/obj/upload.o $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/upload.c
...
$(ZPL_BUILD)/bin/libgo.so: $(DEPS_34)
	@echo '      [Link] $(ZPL_BUILD)/bin/libgo.so'
	$(CC) -shared -o $(ZPL_BUILD)/bin/libgo.so $(LDFLAGS) $(LIBPATHS) "$(ZPL_BUILD)/obj/action.o" "$(ZPL_BUILD)/obj/alloc.o" "$(ZPL_BUILD)/obj/auth.o" "$(ZPL_BUILD)/obj/cgi.o" "$(ZPL_BUILD)/obj/crypt.o" "$(ZPL_BUILD)/obj/file.o" "$(ZPL_BUILD)/obj/fs.o" "$(ZPL_BUILD)/obj/http.o" "$(ZPL_BUILD)/obj/js.o" "$(ZPL_BUILD)/obj/jst.o" "$(ZPL_BUILD)/obj/options.o" "$(ZPL_BUILD)/obj/osdep.o" "$(ZPL_BUILD)/obj/rom.o" "$(ZPL_BUILD)/obj/route.o" "$(ZPL_BUILD)/obj/runtime.o" "$(ZPL_BUILD)/obj/socket.o" "$(ZPL_BUILD)/obj/time.o" "$(ZPL_BUILD)/obj/upload.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
...
#   goahead
#
DEPS_36 += $(ZPL_BUILD)/bin/libgo.so
...
$(ZPL_BUILD)/bin/goahead: $(DEPS_36)
	@echo '      [Link] $(ZPL_BUILD)/bin/goahead'
	$(CC) -o $(ZPL_BUILD)/bin/goahead $(LDFLAGS) $(LIBPATHS) "$(ZPL_BUILD)/obj/goahead.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) $(LIBS) 

#
#   goahead-test
#
DEPS_37 += $(ZPL_BUILD)/bin/libgo.so
...
$(ZPL_BUILD)/bin/goahead-test: $(DEPS_37)
	@echo '      [Link] $(ZPL_BUILD)/bin/goahead-test'
	$(CC) -o $(ZPL_BUILD)/bin/goahead-test $(LDFLAGS) $(LIBPATHS) "$(ZPL_BUILD)/obj/test.o" $(LIBPATHS_37) $(LIBS_37) $(LIBS_37) $(LIBS) $(LIBS) 

#
#   gopass
#
DEPS_38 += $(ZPL_BUILD)/bin/libgo.so
...
$(ZPL_BUILD)/bin/gopass: $(DEPS_38)
	@echo '      [Link] $(ZPL_BUILD)/bin/gopass'
	$(CC) -o $(ZPL_BUILD)/bin/gopass $(LDFLAGS) $(LIBPATHS) "$(ZPL_BUILD)/obj/gopass.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) $(LIBS) 
...
installBinary: $(DEPS_40)
	...
	mkdir -p "$(ME_VAPP_PREFIX)/bin" ; \
	cp $(ZPL_BUILD)/bin/libgo.so $(ME_VAPP_PREFIX)/bin/libgo.so ; \
