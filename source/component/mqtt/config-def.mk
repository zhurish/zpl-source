...
LIB_CPPFLAGS=$(CPPFLAGS) -I. -I.. -I../mqttlib $(ZPLINCLUDE)
...
BROKER_CFLAGS:=${CFLAGS} -DVERSION="\"${VERSION}\"" -DWITH_BROKER $(ZPLINCLUDE)
BROKER_LDFLAGS:=${LDFLAGS}
BROKER_LDADD:=
BROKER_LDADD:=$(BROKER_LDADD)  -ldl -lm -los -L$(ZPL_INSTALL_LIB_DIR) 

BROKER_LDADD:=$(BROKER_LDADD) -lrt
BROKER_LDFLAGS:=$(BROKER_LDFLAGS) -Wl,--dynamic-list=linker.syms
LIB_LIBADD:=$(LIB_LIBADD) -lrt $(ZPLOS_LDLIBS) -L$(ZPL_INSTALL_LIB_DIR) -los
