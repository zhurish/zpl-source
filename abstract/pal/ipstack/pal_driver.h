...
extern int pal_ip_stack_set_mtu(struct interface *ifp, ospl_uint32 mtu);
extern int pal_ip_stack_set_lladdr(struct interface *ifp, ospl_uint8 *mac, ospl_uint32 len);
...
extern int pal_ip_stack_vlanpri_set(struct interface *ifp, ospl_uint32 pri);
extern int pal_ip_stack_promisc_link(struct interface *ifp, ospl_bool enable);

//ip address
extern int pal_ip_stack_change_dhcp(struct interface *ifp, ospl_bool enable);
...
//ip arp
extern int pal_ip_stack_arp_add(struct interface *ifp, struct prefix *address, ospl_uint8 *mac);
...
extern int pal_ip_stack_arp_gratuitousarp_enable(ospl_bool enable);
extern int pal_ip_stack_arp_ttl(ospl_uint32 ttl);
extern int pal_ip_stack_arp_age_timeout(ospl_uint32 timeout);
extern int pal_ip_stack_arp_retry_interval(ospl_uint32 interval);
