...
static int zpl_video_frame_info(zpl_media_buffer_data_t *bufdata)
{
    /*
...
static int zpl_media_rtsp_write_frame(zpl_media_channel_t *mediachn, zpl_media_buffer_data_t *bufdata,  void *pVoidUser)
{
