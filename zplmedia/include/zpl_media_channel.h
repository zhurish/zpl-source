...
typedef int	(*zpl_media_buffer_handler)(zpl_media_channel_t *, const zpl_media_buffer_data_t *,  void *);
...
extern int zpl_media_channel_init();
extern int zpl_media_channel_exit();

extern int zpl_media_channel_count();
extern int zpl_media_channel_load_default();
