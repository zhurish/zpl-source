...
int zpl_media_hal_read_stop(ZPL_MEDIA_HARDADAP_E, zpl_media_channel_t *chn);
int zpl_media_hal_read_start(ZPL_MEDIA_HARDADAP_E, zpl_void *master, zpl_media_channel_t *chn);
