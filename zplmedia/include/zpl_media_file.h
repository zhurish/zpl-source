...
struct zpl_media_file_s
{
    ...
    zpl_buffer_data_t tmppacket;

    int         (*get_frame)(zpl_media_file_t*, zpl_buffer_data_t *);//读取一帧数据回调函数
    int         (*get_extradata)(zpl_media_file_t*, zpl_video_extradata_t *);//读取额外数据回调函数
    int         (*put_frame)(zpl_media_file_t*, zpl_buffer_data_t *);
...
extern int zpl_media_file_write(zpl_media_file_t *file, zpl_buffer_data_t *bufdata);
extern int zpl_media_file_write_data(zpl_media_file_t *file, uint8_t *data, uint32_t len);
extern int zpl_media_file_read(zpl_media_file_t *file, zpl_buffer_data_t *bufdata);
...
extern int zpl_media_file_get_frame_callback(zpl_media_file_t *file, int (*func)(zpl_media_file_t*, zpl_buffer_data_t *));
extern int zpl_media_file_get_extradata_callback(zpl_media_file_t *file, int (*func)(zpl_media_file_t*, zpl_video_extradata_t *));

extern int zpl_media_file_put_frame_callback(zpl_media_file_t *file, int (*func)(zpl_media_file_t*, zpl_buffer_data_t *));
