...
if (WIN32)
    ...
    if (HAVE_WSPIAPI_H OR HAVE_WS2TCPIP_H)
        ...
        # The ipstack_getaddrinfo function is defined to the WspiapiGetAddrInfo inline function
        check_symbol_exists(ipstack_getaddrinfo "winsock2.h;ws2tcpip.h" HAVE_GETADDRINFO)
        unset(CMAKE_REQUIRED_LIBRARIES)
    ...
    check_function_exists(ipstack_getaddrinfo HAVE_GETADDRINFO)
...
if (UNIX)
    if (NOT LINUX)
        # libsocket (Solaris)
        check_library_exists(socket ipstack_getaddrinfo "" HAVE_LIBSOCKET)
        if (HAVE_LIBSOCKET)
            set(HAVE_GETADDRINFO TRUE)
            set(_REQUIRED_LIBRARIES ${_REQUIRED_LIBRARIES} socket)
        endif (HAVE_LIBSOCKET)

        # libnsl/ipstack_inet_pton (Solaris)
        check_library_exists(nsl ipstack_inet_pton "" HAVE_LIBNSL)
        if (HAVE_LIBNSL)
