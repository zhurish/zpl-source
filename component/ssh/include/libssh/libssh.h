...
/* zhurish edit */
LIBSSH_API int ssh_event_session_count(ssh_event event);
LIBSSH_API int ssh_handle_session_timeout(ssh_event event, int time);
LIBSSH_API int ssh_set_session_timeout_cb(ssh_session session, int (*func)(ssh_session, void *, int));
