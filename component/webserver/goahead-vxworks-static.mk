...
prep:
	...
	@[ ! -f $(PL_BUILD)/inc/me.h ] && cp projects/goahead-vxworks-static-me.h $(PL_BUILD)/inc/me.h ; true
	@if ! diff $(PL_BUILD)/inc/me.h projects/goahead-vxworks-static-me.h >/dev/null ; then\
		cp projects/goahead-vxworks-static-me.h $(PL_BUILD)/inc/me.h  ; \
	fi; true
...
$(PL_BUILD)/obj/goahead-openssl.o: \
	...
	$(CC) -c -o $(PL_BUILD)/obj/goahead-openssl.o $(CFLAGS) -DME_DEBUG=1 -DVXWORKS -DRW_MULTI_THREAD -DCPU=PENTIUM -DTOOL_FAMILY=gnu -DTOOL=gnu -D_GNU_TOOL -D_WRS_KERNEL_ -D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\" $(IFLAGS) "-I$(PL_BUILD)/inc" "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead-openssl/goahead-openssl.c
...
$(PL_BUILD)/bin/libmbedtls.a: $(DEPS_33)
	...
	arundefined -cr $(PL_BUILD)/bin/libmbedtls.a "$(PL_BUILD)/obj/mbedtls.o"
endif
...
$(PL_BUILD)/bin/libgoahead-mbedtls.a: $(DEPS_34)
	...
	arundefined -cr $(PL_BUILD)/bin/libgoahead-mbedtls.a "$(PL_BUILD)/obj/goahead-mbedtls.o"
endif
...
$(PL_BUILD)/bin/libgoahead-openssl.a: $(DEPS_35)
	...
	arundefined -cr $(PL_BUILD)/bin/libgoahead-openssl.a "$(PL_BUILD)/obj/goahead-openssl.o"
endif
...
$(PL_BUILD)/bin/goahead.out: $(DEPS_38)
	@echo '      [Link] $(PL_BUILD)/bin/goahead.out'
	$(CC) -o $(PL_BUILD)/bin/goahead.out $(LDFLAGS) $(LIBPATHS)  "$(PL_BUILD)/obj/goahead.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) -Wl,-r 
...
$(PL_BUILD)/bin/goahead-test.out: $(DEPS_39)
	@echo '      [Link] $(PL_BUILD)/bin/goahead-test.out'
	$(CC) -o $(PL_BUILD)/bin/goahead-test.out $(LDFLAGS) $(LIBPATHS)  "$(PL_BUILD)/obj/test.o" $(LIBPATHS_39) $(LIBS_39) $(LIBS_39) $(LIBS) -Wl,-r 
...
$(PL_BUILD)/bin/gopass.out: $(DEPS_40)
	@echo '      [Link] $(PL_BUILD)/bin/gopass.out'
	$(CC) -o $(PL_BUILD)/bin/gopass.out $(LDFLAGS) $(LIBPATHS)  "$(PL_BUILD)/obj/gopass.o" $(LIBPATHS_40) $(LIBS_40) $(LIBS_40) $(LIBS) -Wl,-r 
