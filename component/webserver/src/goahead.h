...
#define ME_MAX_ARGC 32
	...
	#define MAIN(name, _argc, _argv, _envp) int name(_argc, _argv, _envp)

PUBLIC int goahead(int argc, char **argv, char **envp);
...
PUBLIC_DATA int __websLogLevel;
...
#define WEBS_PRIVATE_MAX	32

#ifdef WEBS_PRIVATE_MAX

typedef void (*WebsAppPrivateFree)(void *);
#define WEBS_PRIVATE_DATA_MAX	32

typedef struct WebsAppPrivate {
    int             wid;                /**< Index into webs */
    void			*private_data[WEBS_PRIVATE_DATA_MAX];				/* private data */
    WebsAppPrivateFree private_free[WEBS_PRIVATE_DATA_MAX];
    int				private_size[WEBS_PRIVATE_DATA_MAX];
    int				private_num[WEBS_PRIVATE_DATA_MAX];
}websAppPrivate_t;
...
#define websError(wp, code, fmt, ...) { webs_error (__FILE__, __FUNCTION__, __LINE__, wp, code, fmt, ##__VA_ARGS__); }
/**
...
#define ACCESS_CONTROL_ALLOW_ORIGIN			0x01
#define ACCESS_CONTROL_EXPOSE_HEADERS		0x02
#define ACCESS_CONTROL_MAX_AGE				0x04
#define ACCESS_CONTROL_ALLOW_CREDENTIALS	0x08
#define ACCESS_CONTROL_ALLOW_METHODS		0x10
#define ACCESS_CONTROL_ALLOW_HEADERS		0x20
