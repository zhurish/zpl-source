...
extern modem_serial_t * modem_serial_lookup_api(const char *name);
extern int modem_serial_del_api(const char *name);

extern int modem_serial_callback_api(modem_serial_cb cb, void *pVoid);

extern int modem_serial_bind_api(const char *name, void *client);
extern int modem_serial_unbind_api(const char *name);
