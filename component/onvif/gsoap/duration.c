...
typedef char charLONG64;
typedef unsigned char charULONG64;

SOAP_FMAC3 void SOAP_FMAC4 soap_default_xsd__duration(struct soap *soap, charLONG64 *a)
{
  (void)soap; /* appease -Wall -Werror */
  *a = 0;
}

SOAP_FMAC3 const char * SOAP_FMAC4 soap_xsd__duration2s(struct soap *soap, charLONG64 a)
{
  charLONG64 d;
  int k, h, m, s, f;
  if (a < 0)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_xsd__duration(struct soap *soap, const char *tag, int id, const charLONG64 *a, const char *type)
{
...
SOAP_FMAC3 int SOAP_FMAC4 soap_s2xsd__duration(struct soap *soap, const char *s, charLONG64 *a)
{
  charLONG64 sign = 1, Y = 0, M = 0, D = 0, H = 0, N = 0, S = 0;
  float f = 0.0;
  *a = 0;
  if (s)
  {
    ...
    *a = sign * ((((((((((((Y * 12) + M) * 30) + D) * 24) + H) * 60) + N) * 60) + S) * 1000) + (charLONG64)(1000.0 * f + 0.5));
  }
  return soap->error;
}

SOAP_FMAC3 charLONG64 * SOAP_FMAC4 soap_in_xsd__duration(struct soap *soap, const char *tag, charLONG64 *a, const char *type)
{
  ...
  a = (charLONG64*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_xsd__duration, sizeof(charLONG64), NULL, NULL, NULL, NULL);
  if (*soap->href)
    a = (charLONG64*)soap_id_forward(soap, soap->href, a, 0, SOAP_TYPE_xsd__duration, 0, sizeof(charLONG64), 0, NULL, NULL);
  else if (a)
  {
