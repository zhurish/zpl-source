...
extern int pl_pjsip_log_option(pjsua_app_config *cfg, int option, ospl_bool enable);
extern int pl_pjsip_log_color(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_log_light_bg(pjsua_app_config *cfg, ospl_bool enable);

extern int pl_pjsip_null_audio(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_local_port(pjsua_app_config *cfg, ospl_uint16 lval);
...
extern int pl_pjsip_publish(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_mwi(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_100rel(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_ims(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_update_nat(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_stun(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_compact_form(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_accept_redirect(pjsua_app_config *cfg, int lval);
extern int pl_pjsip_no_force_lr(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_auto_play(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_auto_play_hangup(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_auto_rec(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_auto_loop(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_auto_config(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_ice_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_regular_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_turn_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_ice_max_hosts(pjsua_app_config *cfg, int maxnum);
extern int pl_pjsip_ice_nortcp_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_turn_srv(pjsua_app_config *cfg, char * lval);
extern int pl_pjsip_turn_tcp(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_rtcp_mux(pjsua_app_config *cfg, ospl_bool enable);
#if defined(PJMEDIA_HAS_SRTP) && (PJMEDIA_HAS_SRTP != 0)
extern int pl_pjsip_srtp_enable(pjsua_app_config *cfg, ospl_uint32 type);
extern int pl_pjsip_srtp_secure(pjsua_app_config *cfg, ospl_uint32 type);
extern int pl_pjsip_srtp_keying(pjsua_app_config *cfg, ospl_uint32 type);
#endif
...
extern int pl_pjsip_novad(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_tls_enable(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_tls_verify_server(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_tls_verify_client(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_no_tones(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_jb_max_size(pjsua_app_config *cfg, int value);

#if defined(PJ_HAS_IPV6) && PJ_HAS_IPV6
extern int pl_pjsip_ipv6_enable(pjsua_app_config *cfg, ospl_bool enable);
#endif

extern int pl_pjsip_qos_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_video_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_extra_audio(pjsua_app_config *cfg, ospl_bool enable);
...
extern int pl_pjsip_auto_play_avi(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_cli_enable(pjsua_app_config *cfg, ospl_bool enable);
extern int pl_pjsip_cli_telnet_port(pjsua_app_config *cfg, int port);
extern int pl_pjsip_cli_console(pjsua_app_config *cfg, ospl_bool enable);
/* Set default config. */
