...
# CONFIG_ZPL_LIBRTSP_MODULE is not set
# CONFIG_ZPL_LIBORTP_MODULE is not set
# CONFIG_ZPL_MEDIASTREAM_MODULE is not set
# CONFIG_ZPL_MEDIASTREAM_V4L2 is not set
# CONFIG_ZPL_MEDIASTREAM_ALSA is not set
# CONFIG_ZPL_MEDIASTREAM_SPEEX is not set
# CONFIG_ZPL_MEDIASTREAM_SRTP is not set
# CONFIG_ZPL_MEDIASTREAM_DTLS_SRTP is not set
# CONFIG_ZPL_MEDIASTREAM_ZRTP is not set
# CONFIG_ZPL_MEDIASTREAM_OPENH264 is not set
# CONFIG_ZPL_MEDIASTREAM_UPNP is not set
...
ZPL_MBEDTLS_MODULE=true
# CONFIG_ZPL_FREETYPE_MODULE is not set
