...
#define	IPSTACK_ARPHRD_ATM          IP_ARPHRD_ATM
#define	IPSTACK_ARPHRD_SLIP         IP_ARPHRD_SLIP
#define	IPSTACK_ARPHRD_CSLIP        IP_ARPHRD_CSLIP
#define	IPSTACK_ARPHRD_SLIP6        IP_ARPHRD_SLIP6
#define	IPSTACK_ARPHRD_CSLIP6       IP_ARPHRD_CSLIP6
#define	IPSTACK_ARPHRD_PPP          IP_ARPHRD_PPP
#define	IPSTACK_ARPHRD_CISCO        IP_ARPHRD_CISCO
#define	IPSTACK_ARPHRD_RAWHDLC      IP_ARPHRD_RAWHDLC
#define	IPSTACK_ARPHRD_TUNNEL       IP_ARPHRD_TUNNEL
#define	IPSTACK_ARPHRD_TUNNEL6      IP_ARPHRD_TUNNEL6
#define	IPSTACK_ARPHRD_LOOPBACK     IP_ARPHRD_LOOPBACK
#define	IPSTACK_ARPHRD_SIT          IP_ARPHRD_SIT
#define	IPSTACK_ARPHRD_IPGRE        IP_ARPHRD_IPGRE
#define	IPSTACK_ARPHRD_IEEE80211    IP_ARPHRD_IEEE80211
#ifdef IPSTACK_ARPHRD_IP6GRE
#define	IPSTACK_ARPHRD_IP6GRE       IP_ARPHRD_IP6GRE
#endif
