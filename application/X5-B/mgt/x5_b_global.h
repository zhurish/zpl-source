...
typedef struct
{
	...
	zpl_uint32 openhold;
	zpl_bool	openalarm;
	zpl_uint32 waitclose;
	x5b_app_opentype_t opentype;
	zpl_uint8 wiggins;
	zpl_bool outrelay;
	zpl_bool	tamperalarm;
...
typedef struct
{
	...
	double  		similarLiving;			//活体阈值 zpl_float
	zpl_bool			livenessSwitch;			//活体检测开关
...
extern zpl_bool x5b_app_mode_X5CM();
