...
extern int x5b_app_call_phone_number(x5b_app_mgt_t *mgt, os_tlv_t *tlv, ospl_bool list);


extern int x5b_app_call_user_list(char *json, ospl_uint8 *building, ospl_uint8 *unit,
