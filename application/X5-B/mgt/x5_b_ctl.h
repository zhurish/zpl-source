...
extern int x5b_app_local_mac_address_get(ospl_uint8 *address);
extern int x5b_app_local_address_get(ospl_uint32 *address);
extern int x5b_app_factory_set(x5b_app_factory_t *data);

extern int x5b_app_rtc_tm_set(int timesp);

extern int x5b_app_start_call(ospl_bool start, x5b_app_call_t *call);
extern int x5b_app_start_call_phone(ospl_bool start, char *call);
extern int x5b_app_start_call_user(ospl_bool start, char *call);
extern int x5b_app_stop_call(ospl_bool start, x5b_app_call_t *call);
...
extern ospl_bool x5b_app_port_status_get();


extern int x5b_app_timezone_offset_api(char * res);


extern int x5b_app_call_room_param_get(void *data, ospl_uint8 *building,
