...
typedef struct _RtpTransport
{
	...
	int  (*t_sendto)(struct _RtpTransport *t, mblk_t *msg , int flags, const struct ipstack_sockaddr *to, socklen_t tolen);
	int  (*t_recvfrom)(struct _RtpTransport *t, mblk_t *msg, int flags, struct ipstack_sockaddr *from, socklen_t *fromlen);
