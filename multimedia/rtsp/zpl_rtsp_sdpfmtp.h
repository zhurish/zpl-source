...
struct sdp_attr_fmtp_h264_t
{
        ...
        int sprop_parameter_sets_len;
        char sprop_level_parameter_sets[128];
        int sprop_level_parameter_sets_len;
...
RTSP_API int sdp_attr_fmtp_h264(const char* fmtp, int *format, struct sdp_attr_fmtp_h264_t *h264);
...
RTSP_API int sdp_attr_fmtp_h265(const char* fmtp, int *format, struct sdp_attr_fmtp_h265_t *h265);
