...
/****************************************************************************
	Auxiliary routines
 ****************************************************************************/
static int xioctl(int fd, zpl_uint64 request, void *arg)
{
	int r;
...
static char *prt_caps(zpl_uint32  caps)
{
	static char s[4096] = "";
					 ...
					 double *freq)
{
	...
	{
		frq.frequency = (zpl_uint32 )(((*freq) + d / 2) / d);
