...
//参数变化
typedef int (*ifp_hook)(struct interface *, zpl_bool);
typedef int (*ifp_address_hook)(struct interface *, struct connected *, zpl_bool);
typedef int (*service_hook)(void *, zpl_bool);
typedef int (*debug_hook)(void *, zpl_bool);
typedef int (*ifp_show_hook)(struct interface *, struct vty *, zpl_bool);
