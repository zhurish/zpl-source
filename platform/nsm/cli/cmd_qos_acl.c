...
DEFUN(qos_access_list_ip_protocol,
      ...
      "<1-2147483646> (deny|permit) (A.B.C.D/M|any) (A.B.C.D/M|any) (" IP_TCPUDP_CMD IP_IPPROTO_CMD ")",
      "Access list Seqnum\n"
      "Specify packets to reject\n"
      "Specify packets to forward\n"
      "Specify Source Prefix to match. e.g. 10.0.0.0/8\n"
...
DEFUN(no_qos_access_list_ip_protocol,
      ...
      "no <1-2147483646> (deny|permit) (A.B.C.D/M|any) (A.B.C.D/M|any) (" IP_TCPUDP_CMD IP_IPPROTO_CMD ")",
      NO_STR
      "Access list Seqnum\n"
      "Specify packets to reject\n"
      "Specify packets to forward\n"
...
DEFUN(qos_access_list_ipv6_protocol,
      ...
      "<1-2147483646> (deny|permit) ipv6 (X:X::X:X/M|any) (X:X::X:X/M|any) (" IP_TCPUDP_CMD IP_IPPROTO_CMD ")",
      "Access list Seqnum\n"
      "Specify packets to reject\n"
      "Specify packets to forward\n"
      IPV6_STR
...
DEFUN(no_qos_access_list_ipv6_protocol,
      ...
      "no <1-2147483646> (deny|permit) ipv6 (X:X::X:X/M|any) (X:X::X:X/M|any) (" IP_TCPUDP_CMD IP_IPPROTO_CMD ")",
      NO_STR
      "Access list Seqnum\n"
      "Specify packets to reject\n"
      "Specify packets to forward\n"
