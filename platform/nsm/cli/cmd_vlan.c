...
#ifdef ZPL_CLI_DEBUG
	install_element(ENABLE_NODE, CMD_VIEW_LEVEL, &show_vlan_database_node_cmd);
	install_element(CONFIG_NODE, CMD_VIEW_LEVEL, &show_vlan_database_node_cmd);
#endif

	install_element(ENABLE_NODE, CMD_VIEW_LEVEL, &show_vlan_brief_cmd);
	install_element(CONFIG_NODE, CMD_VIEW_LEVEL, &show_vlan_brief_cmd);
	install_element(VLAN_DATABASE_NODE, CMD_VIEW_LEVEL, &show_vlan_brief_cmd);
