...
static int _qos_access_list_list_init_layer()
{
    ...
    _global_qos_access_list._qos_alc_t.mutex = os_mutex_init();
    ...
    _global_qos_access_list.service_policy_mutex = os_mutex_init();
    _global_qos_access_list.class_map_mutex = os_mutex_init();
    return OK;
}
