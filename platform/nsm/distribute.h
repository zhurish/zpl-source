...
struct distribute_master *distribute_master_list_init (int);
/* Prototypes for distribute-list. */
extern void distribute_list_init (int);
extern void distribute_list_reset (int);
extern void distribute_list_add_hook (int, void (*) (struct distribute *));
extern void distribute_list_delete_hook (int, void (*) (struct distribute *));
