...
/* Define to 1 if you have the `ipstack_inet_ntop' function. */
#define HAVE_INET_NTOP 1

/* Define to 1 if you have the `ipstack_inet_pton' function. */
...
/* Define to 1 if the system has the type `struct ipstack_addrinfo'. */
