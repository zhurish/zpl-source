...
struct if_rmap
{
  ...
  zpl_char *routemap[IF_RMAP_MAX];
};

extern void if_rmap_init (int);
extern void if_rmap_reset (void);
extern void if_rmap_hook_add (zpl_uint16, void (*) (struct if_rmap *));
extern void if_rmap_hook_delete (zpl_uint16, void (*) (struct if_rmap *));
