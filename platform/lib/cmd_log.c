...
int cmd_log_init(void)
{
	...
	install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_config_log_buffer_level_cmd);
	install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_config_log_buffer_module_cmd);
	install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_config_log_buffer_module_level_cmd);
	install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_config_log_buffer_size_cmd);

	install_element(ENABLE_NODE, CMD_CONFIG_LEVEL, &config_logmsg_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_stdout_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_stdout_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_stdout_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_monitor_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_monitor_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_monitor_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_file_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_file_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_file_size_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_file_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_file_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_file_size_cmd);

	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_buffer_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_buffer_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_buffer_size_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_buffer_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_buffer_level_cmd);


	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &save_log_file_cmd);


	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_syslog_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_syslog_level_cmd);

	//install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_syslog_facility_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_syslog_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_syslog_level_cmd);

	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_facility_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_facility_cmd);

	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_trap_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_trap_cmd);

	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_record_priority_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_record_priority_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_timestamp_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_timestamp_cmd);

#ifdef ZPL_SERVICE_SYSLOG
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &syslog_host_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &syslog_host_port_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_syslog_host_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &syslog_mode_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_syslog_mode_cmd);
#endif

#ifdef ZLOG_TESTING_ENABLE
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_testing_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_testing_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_testing_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_testing_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_testing_file_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &config_log_testing_file_level_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_testing_file_cmd);
	install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_config_log_testing_file_level_cmd);
	install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_config_log_file_testing_cmd);
#endif
	return OK;
}
