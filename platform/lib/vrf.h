...
extern struct vrf * nsm_vrf_create (const char *name);
extern int nsm_vrf_delete (const char *name);
extern int nsm_vrf_set_vrfid (struct vrf *vrf, vrf_id_t vrf_id);

extern void vrf_terminate (void);

extern void nsm_vrf_init (void);
/*
 * VRF utilities
 */
...
extern zpl_socket_t nsm_halpal_vrf_socket(int domain, zpl_uint32 type, zpl_uint16 protocol, vrf_id_t vrf_id);
