      ...
      if (match)
	{
	  ...
	  if (pentry->any)
	  ...
	  else
	    {
	      ...
	      vty_out (vty, "%s/%d",
		       ipstack_inet_ntop (pp->family, &pp->u.prefix, buf, BUFSIZ),
			   pp->prefixlen);
...
prefix_bgp_orf_entry (struct stream *s, struct prefix_list *plist,
		      zpl_uchar init_flag, zpl_uchar permit_flag, zpl_uchar deny_flag)
{
  struct prefix_list_entry *pentry;
  ...
  for (pentry = plist->head; pentry; pentry = pentry->next)
    {
      zpl_uchar flag = init_flag;
      struct prefix *p = &pentry->prefix;

      flag |= (pentry->type == PREFIX_PERMIT ?
               permit_flag : deny_flag);
      stream_putc (s, flag);
      stream_putl (s, (zpl_uint32)pentry->seq);
      stream_putc (s, (zpl_uchar)pentry->ge);
      stream_putc (s, (zpl_uchar)pentry->le);
...
int
prefix_bgp_orf_set (zpl_char *name, afi_t afi, struct orf_prefix *orfp,
		    int permit, int set)
{
  struct prefix_list *plist;
  struct prefix_list_entry *pentry;
...
void
prefix_bgp_orf_remove_all (afi_t afi, zpl_char *name)
{
  struct prefix_list *plist;
...
prefix_list_init_ipv4 (void)
{
  ...
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_le_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_seq_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_seq_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_seq_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_seq_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_seq_le_ge_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_prefix_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_le_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_seq_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_seq_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_seq_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_seq_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_seq_le_ge_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_description_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_description_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_description_arg_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ip_prefix_list_sequence_number_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ip_prefix_list_sequence_number_cmd);

  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_name_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_name_seq_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_prefix_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_prefix_longer_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_prefix_first_match_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_summary_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_summary_name_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_detail_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ip_prefix_list_detail_name_cmd);

  install_element (ENABLE_NODE, CMD_CONFIG_LEVEL, &clear_ip_prefix_list_cmd);
  install_element (ENABLE_NODE, CMD_CONFIG_LEVEL, &clear_ip_prefix_list_name_cmd);
...
prefix_list_init_ipv6 (void)
{
  ...
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_le_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_seq_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_seq_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_seq_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_seq_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_seq_le_ge_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_prefix_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_le_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_seq_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_seq_ge_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_seq_ge_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_seq_le_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_seq_le_ge_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_description_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_description_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_description_arg_cmd);

  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &ipv6_prefix_list_sequence_number_cmd);
  install_element(CONFIG_NODE, CMD_CONFIG_LEVEL, &no_ipv6_prefix_list_sequence_number_cmd);

  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_name_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_name_seq_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_prefix_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_prefix_longer_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_prefix_first_match_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_summary_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_summary_name_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_detail_cmd);
  install_element(VIEW_NODE, CMD_VIEW_LEVEL, &show_ipv6_prefix_list_detail_name_cmd);

  install_element (ENABLE_NODE, CMD_CONFIG_LEVEL, &clear_ipv6_prefix_list_cmd);
  install_element (ENABLE_NODE, CMD_CONFIG_LEVEL, &clear_ipv6_prefix_list_name_cmd);
  install_element (ENABLE_NODE, CMD_CONFIG_LEVEL, &clear_ipv6_prefix_list_name_prefix_cmd);
}
#endif
#endif
void
