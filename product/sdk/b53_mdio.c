...
int b53125_config_init(struct b53125_device *dev)
{
	...
	/*******global *******/
	b53_brcm_hdr_setup(dev, zpl_true, dev->cpu_port);

	ret |= b53125_imp_enable(dev, zpl_false);//关闭IMP接口
	...
	ret |= b53125_enable_learning(dev, dev->cpu_port, zpl_true);
	...
	ret |= b53125_software_learning(dev, dev->cpu_port, zpl_true);
	ret |= b53125_software_learning(dev, 0, zpl_true);
	ret |= b53125_software_learning(dev, 1, zpl_true);
	ret |= b53125_software_learning(dev, 2, zpl_true);
	ret |= b53125_software_learning(dev, 3, zpl_true);
	ret |= b53125_software_learning(dev, 4, zpl_true);
	ret |= b53125_software_learning(dev, 6, zpl_true);

	ret |= b53125_imp_enable(dev, zpl_true);
...
/*	void b53_brcm_hdr_setup(struct b53125_device *dev, zpl_bool enable, int port);
	int b53125_switch_mode(struct b53125_device *dev, zpl_bool manege);
	...
	int b53125_imp_mode(struct b53125_device *dev, zpl_bool enable);*/
