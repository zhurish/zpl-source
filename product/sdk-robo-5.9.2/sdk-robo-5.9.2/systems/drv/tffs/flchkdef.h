 ...
 *
 * 
 *    Rev 1.16   Nov 11 2002 15:35:10   OriS
 * Added default customization for DiskOnChip memory window access macros.
 * 
 *    Rev 1.15   Oct 31 2002 17:07:50   oris
 * Changed bios driver version to "5140"
 * 
 *    Rev 1.14   Oct 23 2002 12:00:10   oris
 * Added BiosDriverEXBVersion definition and incremented TrueFFSVersion version.
 * 
 *    Rev 1.13   Jul 04 2002 18:04:44   oris
 * Update TrueFFS version.
 * 
...
/* TrueFFS version
 *
 * Number written on the flash by INFTL format specifing the TrueFFS version
 * The media was formated with. the number bellow specifies version
 * 5.1.4.0
 */

#define TrueFFSVersion "5140"         

/* BIOS Driver EXB file competability version
 *
 * This number is compared to the one written in the EXB file header
 * The TrueFFS formatter will reject files with BIOS driver version other
 * then the one it was compiled with.
 */

#define BiosDriverEXBVersion "5140"   
