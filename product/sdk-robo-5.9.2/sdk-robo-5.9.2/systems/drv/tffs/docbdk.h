/*
 * $Log: docbdk.h,v $
 * Revision 1.2  2004/11/12 09:33:24  kevinwu
 * Change for TFFS 5.1.4
 *
 * 
 *    Rev 1.15   Oct 31 2002 14:56:08   oris
 * Changed second INFTL header offset to 8*512.
 * 
...
#define BDK_HEADERS_SPACING             (SECTOR_SIZE * 8UL)
