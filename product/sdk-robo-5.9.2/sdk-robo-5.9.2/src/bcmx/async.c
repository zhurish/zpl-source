 ...
 *
 * $Id: async.c,v 1.255.4.4 Broadcom SDK $
 ...
 * Generated:	Sat Oct 16 01:45:10 2010
 */
...
void
bcmx_port_control_timesync_get_async(
	bcm_gport_t port,
	...
	void *async_cookie)
{
	...
	async->next = NULL;
	async->type = BCMX_ASYNC_ENTRY_PORT_CONTROL_TIMESYNC_GET;
	async->run = bcmx_async_run;
	async->callback = async_callback;
	async->cookie = async_cookie;
	async->args.port_control_timesync_get.port = port;
	async->args.port_control_timesync_get.type = type;
	async->args.port_control_timesync_get.value = value;
	bcm_async_add((bcm_async_req_t *)async);
}

void
bcmx_port_control_timesync_set_async(
	bcm_gport_t port,
	bcm_port_control_timesync_t type,
	uint64 value,
	bcmx_async_cb_t async_callback,
	void *async_cookie)
{
	...
	async->next = NULL;
	async->type = BCMX_ASYNC_ENTRY_PORT_CONTROL_TIMESYNC_SET;
	async->run = bcmx_async_run;
	async->callback = async_callback;
	async->cookie = async_cookie;
	async->args.port_control_timesync_set.port = port;
	async->args.port_control_timesync_set.type = type;
	async->args.port_control_timesync_set.value = value;
	bcm_async_add((bcm_async_req_t *)async);
}
...
void
bcmx_port_timesync_config_get_async(
	bcm_gport_t port,
	...
	void *async_cookie)
{
	...
	async->next = NULL;
	async->type = BCMX_ASYNC_ENTRY_PORT_TIMESYNC_CONFIG_GET;
	async->run = bcmx_async_run;
	async->callback = async_callback;
	async->cookie = async_cookie;
	async->args.port_timesync_config_get.port = port;
	async->args.port_timesync_config_get.conf = conf;
	bcm_async_add((bcm_async_req_t *)async);
}

void
bcmx_port_timesync_config_set_async(
	bcm_gport_t port,
	bcmx_port_timesync_config_t * conf,
	bcmx_async_cb_t async_callback,
	void *async_cookie)
{
	...
	async->next = NULL;
	async->type = BCMX_ASYNC_ENTRY_PORT_TIMESYNC_CONFIG_SET;
	async->run = bcmx_async_run;
	async->callback = async_callback;
	async->cookie = async_cookie;
	async->args.port_timesync_config_set.port = port;
	async->args.port_timesync_config_set.conf = conf;
	bcm_async_add((bcm_async_req_t *)async);
}
