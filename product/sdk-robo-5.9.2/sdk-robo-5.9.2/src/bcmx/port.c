...
#define BCMX_PORT_TIMESYNC_CONFIG_T_PTR_TO_BCM(_config)    \
    ((bcm_port_timesync_config_t *)(_config))
...
/*
 * Function:
 *      bcmx_port_timesync_config_t_init
 * Purpose:
 *      Initialize a port timesync config object struct.
 * Parameters:
 ...
 */
void
bcmx_port_timesync_config_t_init(bcmx_port_timesync_config_t *conf)
{
    if (conf != NULL) {
...
/*
 * Function:
 *     bcmx_port_timesync_config_set
 * Purpose:
 *     Set timesync configuration for port.
 * Parameters:
 *     port - Port
 ...
 */
int
bcmx_port_timesync_config_set(bcm_gport_t port, 
                              bcmx_port_timesync_config_t *conf)
{
    ...
    return bcm_port_timesync_config_set(bcm_unit, port,
...
/*
 * Function:
 *     bcmx_port_timesync_config_get
 * Purpose:
 *     Get timesync configuration for port.
 * Parameters:
 *     port - Port
 ...
 */
int
bcmx_port_timesync_config_get(bcm_gport_t port, 
                              bcmx_port_timesync_config_t *conf)
{
    int         bcm_unit;
    bcm_port_t  bcm_port;
    ...
    return bcm_port_timesync_config_get(bcm_unit, port,
                                        BCMX_PORT_TIMESYNC_CONFIG_T_PTR_TO_BCM
                                        (conf));
}
...
/*
 * Function:
 *     bcmx_port_control_timesync_set
 * Purpose:
 *     Set timesync control value.
 * Parameters:
 *     port  - Port
 ...
 */
int
bcmx_port_control_timesync_set(bcm_gport_t port, 
                               bcm_port_control_timesync_t type, uint64 value)
{
    int         bcm_unit;
    bcm_port_t  bcm_port;
    ...
    return bcm_port_control_timesync_set(bcm_unit, port, type, value);
}


/*
 * Function:
 *     bcmx_port_control_timesync_get
 * Purpose:
 *     Get timesync control value.
 * Parameters:
 *     port  - Port
 *     type  - Timesync control
 *     value - (OUT) Value
 ...
 */
int
bcmx_port_control_timesync_get(bcm_gport_t port, 
                               bcm_port_control_timesync_t type, uint64 *value)
{
    int         bcm_unit;
    bcm_port_t  bcm_port;
    ...
    return bcm_port_control_timesync_get(bcm_unit, port, type, value);
}
