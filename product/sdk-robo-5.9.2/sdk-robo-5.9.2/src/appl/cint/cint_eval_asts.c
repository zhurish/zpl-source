/*
 * $Id: cint_eval_asts.c,v 1.45 Broadcom SDK $
...
__cint_eval_ast_For(cint_ast_t* ast)
{
    ...
    for(cint_eval_ast(ast->utype._for.pre); 
        ast->utype._for.condition ? cint_logical_value(cint_eval_ast(ast->utype._for.condition)) : 1; 
...
cint_eval_ast(cint_ast_t* ast)
{
    ...
    is_ident = (ast->ntype == cintAstIdentifier);
