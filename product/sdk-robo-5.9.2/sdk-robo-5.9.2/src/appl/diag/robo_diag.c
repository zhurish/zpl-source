/*
 * $Id: robo_diag.c,v 1.71 Broadcom SDK $
...
char cmd_robo_counter_usage[] =
    ...
    "\n"
    "\tcounter debug set <type_name> <counter_reg>\n\t"
    "                   - Set debug counter to count certain packet types.\n\t"
    "counter debug get <type_name>\n\t"
    "                   - Get debug counter select value\n\t"
    "counter debug show - Show all debug counters config\n"
#endif
    ;
...
char if_robo_dscp_usage[] =
    ...
    "2) TB B0 dscp value can be or'd with BCM_DSCP_ECN(0x100) \n\t"
...
*/
    ...
    "  show VlanMapping    - Show last hit IVM/EVM entry IDs (BCM5328x B0 only)\n"
