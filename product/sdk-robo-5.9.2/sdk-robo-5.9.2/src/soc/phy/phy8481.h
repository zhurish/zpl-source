/*
 * $Id: phy8481.h,v 1.38 Broadcom SDK $
...
#define READ_PHY8481_EEE_LPABILr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_AN_REG((_unit), (_phy_ctrl), 0x3e,(_val))
#define WRITE_PHY8481_EEE_LPABILr(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_AN_REG((_unit), (_phy_ctrl), 0x3e,(_val))
#define MODIFY_PHY8481_EEE_LPABILr(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_AN_REG((_unit), (_phy_ctrl), 0x3e, (_val), (_mask))
...
#define TOP_CONFIG_AUTOGREEN_CONFIG1_REG    0x400b

#define READ_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(_unit, _phy_ctrl, _val) \
            READ_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG1_REG, (_val))

#define WRITE_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG1_REG, (_val))

#define MODIFY_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG1_REG, (_val), (_mask))

#define TOP_CONFIG_AUTOGREEN_CONFIG2_REG    0x400c

#define READ_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG2_REG(_unit, _phy_ctrl, _val) \
            READ_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG2_REG, (_val))

#define WRITE_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG2_REG(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG2_REG, (_val))

#define MODIFY_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG2_REG(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_TOPLVL1_REG((_unit), (_phy_ctrl), \
            TOP_CONFIG_AUTOGREEN_CONFIG2_REG, (_val), (_mask))
