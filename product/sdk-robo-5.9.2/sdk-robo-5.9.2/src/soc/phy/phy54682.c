/*
 * $Id: phy54682.c,v 1.22.4.16 Broadcom SDK $
...
void _phy_54682e_encode_egress_message_mode(soc_port_timesync_event_message_egress_mode_t mode,
...
void _phy_54682e_encode_ingress_message_mode(soc_port_timesync_event_message_ingress_mode_t mode,
                                            int offset, uint16 *value)
{
...
STATIC int
phy_54682_timesync_config_set(int unit, soc_port_t port, soc_port_timesync_config_t *conf)
{
    ...
    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x27, (COMPILER_64_LO(conf->original_timecode.seconds) & 0xffff)));

    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x28, ((COMPILER_64_LO(conf->original_timecode.seconds) >> 16) & 0xffff)));

    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x29, (COMPILER_64_HI(conf->original_timecode.seconds) & 0xffff)));

    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_modify(unit, pc_port1, 0, 0x4f, ((conf->gmode + 1) << 14), 
                                       (3U << 14))); /* +1 does the encoding  for the chip */
    /* tx/rx_timestamp_offset */
    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x15 + offset, (uint16)(((conf->rx_timestamp_offset & 0xf0000) >> 4) |
    ...
    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_modify(unit, pc, 0, 0x11, value, 0x00ff)); 
    ...
    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_modify(unit, pc, 0, 0x12, value << 8, 0xff00)); 

    return SOC_E_NONE;
}

STATIC int
phy_54682_timesync_config_get(int unit, soc_port_t port, soc_port_timesync_config_t *conf)
{
    phy_ctrl_t *pc, *pc_port1;
    soc_phy_chip_info_t *chip_info;
    soc_port_t primary_port;
    ...
    /* rx_timestamp_offset */
    SOC_IF_ERROR_RETURN
        (_phy_54682e_blk_top_lvl_reg_read(unit, pc_port1, 0, 0x1d + offset, &temp2));
...
STATIC int
phy_54682_timesync_control_set(int unit, soc_port_t port, soc_port_control_timesync_t type, uint64 value)
{
    phy_ctrl_t *pc, *pc_port1;
    soc_phy_chip_info_t *chip_info;
    soc_port_t primary_port;
    ...
    case SOC_PORT_CONTROL_TIMESYNC_NCOADDEND:
        SOC_IF_ERROR_RETURN
            (_phy_54682e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x44, COMPILER_64_LO(value)));
        break;

    case SOC_PORT_CONTROL_TIMESYNC_FRAMESYNC:
        SOC_IF_ERROR_RETURN
            (_phy_54682e_blk_top_lvl_reg_modify(unit, pc_port1, 0, 0x4f, COMPILER_64_LO(value) ? (1U << 5) : 0, 
                                       (0xF << 2)));
        break;
...
STATIC int
phy_54682_timesync_control_get(int unit, soc_port_t port, soc_port_control_timesync_t type, uint64 *value)
{
    phy_ctrl_t *pc, *pc_port1;
    soc_phy_chip_info_t *chip_info;
    soc_port_t primary_port;
    ...
    case SOC_PORT_CONTROL_TIMESYNC_HEARTBEAT_TIMESTAMP:
        SOC_IF_ERROR_RETURN
            (MODIFY_PHY54682_EXP_READ_START_END_CTRLr(unit, pc_port1, 0x1 << 0, 0x3 << 0 ));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_HEARTBEAT_TIMESTAMPr(unit, pc_port1, &value0));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_HEARTBEAT_TIMESTAMPr(unit, pc_port1, &value1));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_HEARTBEAT_TIMESTAMPr(unit, pc_port1, &value2));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_HEARTBEAT_TIMESTAMPr(unit, pc_port1, &value3));
        SOC_IF_ERROR_RETURN
            (MODIFY_PHY54682_EXP_READ_START_END_CTRLr(unit, pc_port1,0x2 << 0, 0x3 << 0 ));
    ...
    case SOC_PORT_CONTROL_TIMESYNC_CAPTURE_TIMESTAMP:
        SOC_IF_ERROR_RETURN
            (MODIFY_PHY54682_EXP_READ_START_END_CTRLr(unit, pc_port1, 0x1 << 2, 0x3 << 2 ));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_CAPTURE_TIMESTAMPr(unit, pc_port1, &value0));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_CAPTURE_TIMESTAMPr(unit, pc_port1, &value1));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_CAPTURE_TIMESTAMPr(unit, pc_port1, &value2));
        SOC_IF_ERROR_RETURN
            (READ_PHY54682_EXP_CAPTURE_TIMESTAMPr(unit, pc_port1, &value3));
        SOC_IF_ERROR_RETURN
            (MODIFY_PHY54682_EXP_READ_START_END_CTRLr(unit, pc_port1, 0x2 << 2, 0x3 << 2 ));
    ...
    case SOC_PORT_CONTROL_TIMESYNC_FRAMESYNC:
        SOC_IF_ERROR_RETURN
            (_phy_54682e_blk_top_lvl_reg_read(unit, pc_port1, 0, 0x4f, &value0));
        /* *value = (value0 & (1U << 5)) > 0; */
