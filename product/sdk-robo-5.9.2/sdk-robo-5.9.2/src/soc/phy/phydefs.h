/*
 * $Id: phydefs.h,v 1.20 Broadcom SDK $
...
#if defined(INCLUDE_PHY_54640) && defined(BCM_ESW_SUPPORT)
#define INCLUDE_PHY_54640_ESW
#endif /* INCLUDE_PHY_54640 && BCM_ESW_SUPPORT */
