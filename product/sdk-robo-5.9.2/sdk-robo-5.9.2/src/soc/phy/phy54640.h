/*
 * $Id: phy54640.h,v 1.8 Broadcom SDK $
...
#define READ_PHY54640_EXP_HEARTBEAT_TIMESTAMPr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0fd0, 0x15, (_val))

#define READ_PHY54640_EXP_CAPTURE_TIMESTAMPr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0fd1, 0x15, (_val))
