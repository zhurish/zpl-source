...
/*
 * $Id: phy8750.c,v 1.11.6.2 Broadcom SDK $
...
_phy8754_rom_load(int unit, int port, phy_ctrl_t *pc)
{
    ...
    /* 0xc0c0: RXLOS override: 0x0808 MOD_ABS override */
    SOC_IF_ERROR_RETURN
       (WRITE_PHY8750_MMF_PMA_PMD_REG(unit,pc,0xC8E4, 0xc8c8));
#endif /* RXLOS_OVERRIDE_ENABLE */
...
phy_8750_init(int unit, soc_port_t port)
{
    ...
    SOC_IF_ERROR_RETURN(
        PHY8750_MMF(unit, pc));
    SOC_IF_ERROR_RETURN(
        MODIFY_PHY8750_MMF_PMA_PMD_REG(unit, pc, 0xc8e4, (1U<<12), ((1U<<12) | (1U<<4))));
