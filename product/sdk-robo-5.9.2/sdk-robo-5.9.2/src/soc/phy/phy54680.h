/*
 * $Id: phy54680.h,v 1.11 Broadcom SDK $
...
#define READ_PHY54680_EXP_HEARTBEAT_TIMESTAMPr(_unit, _phy_ctrl, _val) \
            PHY54680_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0fd0, 0x15, (_val))

#define READ_PHY54680_EXP_CAPTURE_TIMESTAMPr(_unit, _phy_ctrl, _val) \
            PHY54680_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0fd1, 0x15, (_val))
