...
/*
 * $Id: phy8481.c,v 1.121.4.1 Broadcom SDK $
...
phy_8481_init(int unit, soc_port_t port)
{
...

    {
        ...
        if ((fw_ver_main >= 0x3) && (fw_ver_branch >= 0x2)) {
...
#if 0
    SOC_IF_ERROR_RETURN
        (READ_PHY8481_TOPLVL1_REG(unit, pc, 0x4095, &status));

    *link =  (status & (1U<<13)) ? TRUE : FALSE;
#endif
                                ...
                                soc_phy_control_t type, uint32 value)
{
    ...
    case SOC_PHY_CONTROL_EEE:
        ...
        SOC_IF_ERROR_RETURN
           (MODIFY_PHY8481_EEE_ADVr(unit, pc, value ? 0xe : 0, 0xe));

        if (value) {
            /* Disable AUTO EEE if native is enabled */
            SOC_IF_ERROR_RETURN
               (MODIFY_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(unit, pc, 0, 0x1));
        }
    ...
    case SOC_PHY_CONTROL_EEE_AUTO:
        ...
        SOC_IF_ERROR_RETURN
           (MODIFY_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(unit, pc, value ? 1U : 0, 1U));

        if (value) {
            /* Disable Native EEE if AUTO EEE is enabled */
            SOC_IF_ERROR_RETURN
               (WRITE_PHY8481_EEE_ADVr(unit, pc, 0));
        }
    ...
    case SOC_PHY_CONTROL_EEE_AUTO_FIXED_LATENCY:
        ...
        SOC_IF_ERROR_RETURN
           (MODIFY_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(unit, pc, value ? 1U<<1 : 0, 1U<<1));
        break;
    ...
    case SOC_PHY_CONTROL_EEE_AUTO_IDLE_THRESHOLD:
        ...
        SOC_IF_ERROR_RETURN
           (WRITE_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG2_REG(unit, pc, (uint16)(value & 0xffff)));
                                ...
                                soc_phy_control_t type, uint32 *value)
{
    ...
    case SOC_PHY_CONTROL_EEE:
        ...
        SOC_IF_ERROR_RETURN
           (READ_PHY8481_EEE_ADVr(unit, pc, &temp));
        *value = (temp & 0xe) ? 1 : 0;
        break;
    ...
    case SOC_PHY_CONTROL_EEE_AUTO:
        ...
        SOC_IF_ERROR_RETURN
           (READ_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG1_REG(unit, pc, &temp));
        *value = temp & 0x1;
        break;
    ...
    case SOC_PHY_CONTROL_EEE_AUTO_IDLE_THRESHOLD:
        ...
        SOC_IF_ERROR_RETURN
           (READ_PHY8481_TOP_CONFIG_AUTOGREEN_CONFIG2_REG(unit, pc, &temp));
        *value = temp;
        break;
