/*
 * $Id: gxumac.c,v 1.10.6.1 Broadcom SDK $
...
#if defined(BCM_BIGMAC_SUPPORT) || defined(BCM_XMAC_SUPPORT)
...
{
    return _mac_combo_10g_mac(unit)->md_encap_set(unit, port, type);
}
...
#endif /* BCM_BIGMAC_SUPPORT || BCM_XMAC_SUPPORT */
