/*
 * $Id: field.c,v 1.46.6.2 Broadcom SDK $
...
#define MAX_USER_FLOW_ID(unit) \
    (SOC_IS_TB_B0(unit) ?  MAX_USER_FLOW_ID_B0(unit) : MAX_USER_FLOW_ID_A0(unit))
            ...
            int tcam_idx, int *tcam_chain_idx)
{
    ...
    switch(stage_id) {
        case DRV_FIELD_STAGE_INGRESS:
            rv = _tb_fp_entry_cfp_tcam_policy_install(unit, entry, tcam_idx, *tcam_chain_idx);
            break;
        case DRV_FIELD_STAGE_LOOKUP:
        ...
        int param1, void *param2)
{
    ...
    switch (op) {
        case DRV_FIELD_ENTRY_TCAM_SLICE_ID_SET:
            rv = _tb_fp_entry_tcam_slice_id_set(unit, stage_id, drv_entry, param1, param2);
            break;
        ...
        case DRV_FIELD_ENTRY_TCAM_CHAIN_MODE_GET:            
            rv = _tb_fp_entry_tcam_chain_mode_get(unit, stage_id, drv_entry, param1, param2);
            break;                
