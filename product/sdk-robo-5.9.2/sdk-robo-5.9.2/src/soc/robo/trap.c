...
/* the filed value in bcm5348 IGMP/MLD related register 
 *  - 0x2 is invalid.
 */
#define BCM5348_REG_SNOOP_DISABLE   0x0
#define BCM5348_REG_SNOOP_MODE      0x1
#define BCM5348_REG_TRAP_MODE       0x3
...
drv_bcm5348_igmp_mld_snoop_mode_get(int unit, int type, int *mode)
{
    ...
    *mode = (temp == BCM5348_REG_SNOOP_MODE) ? DRV_IGMP_MLD_MODE_SNOOP : 
            (temp == BCM5348_REG_TRAP_MODE) ? DRV_IGMP_MLD_MODE_TRAP : 
...
drv_bcm5348_igmp_mld_snoop_mode_set(int unit, int type, int mode)
{
    ...
    if (mode == DRV_IGMP_MLD_MODE_DISABLE){
        temp = BCM5348_REG_SNOOP_DISABLE;
    } else {
        if ((mode == DRV_IGMP_MLD_MODE_TRAP) || 
                (mode == DRV_IGMP_MLD_MODE_ENABLE)){
            temp = BCM5348_REG_TRAP_MODE;
        } else if (mode == DRV_IGMP_MLD_MODE_SNOOP){
            temp = BCM5348_REG_SNOOP_MODE;
        } else {
 ...
 *  - 0x2 is invalid.
 */
#define BCM53242_REG_SNOOP_DISABLE  0x0
#define BCM53242_REG_SNOOP_MODE     0x1
#define BCM53242_REG_TRAP_MODE      0x3
/*
 *  Function : drv_igmp_mld_snoop_mode_get
 *
 *  Purpose :
...
drv_bcm53242_igmp_mld_snoop_mode_get(int unit, int type, int *mode)
{
    ...
    *mode = (temp == BCM53242_REG_SNOOP_MODE) ? DRV_IGMP_MLD_MODE_SNOOP : 
            (temp == BCM53242_REG_TRAP_MODE) ? DRV_IGMP_MLD_MODE_TRAP : 
                DRV_IGMP_MLD_MODE_DISABLE;
...
drv_bcm53242_igmp_mld_snoop_mode_set(int unit, int type, int mode)
{
    ...
    if (mode == DRV_IGMP_MLD_MODE_DISABLE){
        temp = BCM53242_REG_SNOOP_DISABLE;
    } else {
        if ((mode == DRV_IGMP_MLD_MODE_TRAP) || 
                (mode == DRV_IGMP_MLD_MODE_ENABLE)){
            temp = BCM53242_REG_TRAP_MODE;
        } else if (mode == DRV_IGMP_MLD_MODE_SNOOP){
            temp = BCM53242_REG_SNOOP_MODE;
        } else {
