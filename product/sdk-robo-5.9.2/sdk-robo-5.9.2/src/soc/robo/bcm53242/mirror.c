/*
 * $Id: mirror.c,v 1.4 Broadcom SDK $
 *
    ...
    soc_pbmp_t ingress_bmp, soc_pbmp_t egress_bmp)
{
    ...
    SOC_IF_ERROR_RETURN(
        ...
        (unit, IGMIRCTLr, (uint32 *)&reg_value, IN_MIR_MSKf, &temp32));
    ...
    SOC_IF_ERROR_RETURN(
        (DRV_SERVICES(unit)->reg_field_set)
        (unit, EGMIRCTLr, (uint32 *)&reg_value, OUT_MIR_MSKf, &temp32));
    ...
    SOC_IF_ERROR_RETURN(
        (DRV_SERVICES(unit)->reg_field_set)
        (unit, MIRCAPCTLr, (uint32 *)&reg_value, SMIR_CAP_PORTf, &temp32));
