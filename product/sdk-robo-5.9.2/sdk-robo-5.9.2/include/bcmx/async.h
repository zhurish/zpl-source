 ...
 *
 * $Id: async.h,v 1.252.4.4 Broadcom SDK $
...
void	bcmx_port_control_timesync_get_async(bcm_gport_t port, bcm_port_control_timesync_t type, uint64 * value, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_port_control_timesync_set_async(bcm_gport_t port, bcm_port_control_timesync_t type, uint64 value, bcmx_async_cb_t async_callback, void *async_cookie);
...
void	bcmx_port_timesync_config_get_async(bcm_gport_t port, bcmx_port_timesync_config_t * conf, bcmx_async_cb_t async_callback, void *async_cookie);
void	bcmx_port_timesync_config_set_async(bcm_gport_t port, bcmx_port_timesync_config_t * conf, bcmx_async_cb_t async_callback, void *async_cookie);
