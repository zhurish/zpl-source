 ...
 *
 * $Id: xasync_req.h,v 1.256.4.4 Broadcom SDK $
...
typedef struct bcmx_async_req_s {
	...
	union {
		...
		struct {
			...
			uint64 * value;
		} port_control_timesync_get;
		struct {
			bcm_gport_t port;
			bcm_port_control_timesync_t type;
			uint64 value;
		} port_control_timesync_set;
		struct {
			bcmx_lport_t port;
			int * mode;
		} port_discard_get;
...
typedef enum {
	...
	BCMX_ASYNC_ENTRY_PORT_CONTROL_TIMESYNC_GET,
	BCMX_ASYNC_ENTRY_PORT_CONTROL_TIMESYNC_SET,
	...
	BCMX_ASYNC_ENTRY_PORT_TIMESYNC_CONFIG_GET,
	BCMX_ASYNC_ENTRY_PORT_TIMESYNC_CONFIG_SET,
