/*
 * $Id: drv.h,v 1.318.4.8 Broadcom SDK $
...
#define SOC_IS_DRACO(unit)      ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_DRACO))
#else
...
#define SOC_IS_HBX(unit)        ((!SOC_INFO(unit).spi_device) && \
                ...
                (SOC_INFO(unit).chip_type == SOC_INFO_SHADOW)))
...
#define SOC_IS_HELIX1(unit)     ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_HELIX))
#define SOC_IS_HELIX15(unit)    ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_HELIX15))
#define SOC_IS_HELIX(unit)      ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_HELIX_ANY))
#else
...
#define SOC_IS_FELIX1(unit)     ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_FELIX))
#define SOC_IS_FELIX15(unit)    ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_FELIX15))
#define SOC_IS_FELIX(unit)      ((!SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_FELIX_ANY))
#else
...
#define SOC_IS_ROBO(unit)        ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO))
#define SOC_IS_ROBO5324(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5324))
#define SOC_IS_ROBO5324_A1(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5324_A1))
#define SOC_IS_ROBO5396(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5396))
#define SOC_IS_ROBO5389(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5389))
#define SOC_IS_ROBO5398(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5398))
#define SOC_IS_ROBODINO(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & (SOC_INFO_ROBO5389|SOC_INFO_ROBO5396)))
#define SOC_IS_ROBO5348(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5348))
#define SOC_IS_ROBO5397(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5397))
#define SOC_IS_ROBO5347(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5347))
#define SOC_IS_ROBO5395(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO5395))
#define SOC_IS_ROBO53242(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53242))
#define SOC_IS_ROBO53262(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53262))
#define SOC_IS_ROBO53115(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53115))
#define SOC_IS_ROBO53118(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53118))
#define SOC_IS_ROBO53101(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53101))
#define SOC_IS_ROBO53280(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53280))
#define SOC_IS_ROBO53125(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53125))                
#define SOC_IS_ROBO53128(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53128)) 
#define SOC_IS_ROBO53128V(unit)   ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53128V)) 
#ifdef BCM_TB_SUPPORT
#define SOC_IS_TB(unit)          ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53280))
#define SOC_IS_TB_B0(unit)          ((SOC_INFO(unit).spi_device) && \
                (SOC_INFO(unit).chip & SOC_INFO_ROBO53280_B0))
#else
#define SOC_IS_TB(unit)         (0)
#define SOC_IS_TB_B0(unit)      (0)
#endif
#define SOC_IS_ROBO5325(unit) (0)
#define SOC_IS_ROBO_GE_SWITCH(unit) ((SOC_INFO(unit).spi_device) && \
                                     (SOC_INFO(unit).chip & (SOC_INFO_ROBO5389|\
                                     SOC_INFO_ROBO5396 | SOC_INFO_ROBO5398 |\
                                     SOC_INFO_ROBO5397 | SOC_INFO_ROBO5395 |\
                                     SOC_INFO_ROBO53115 | SOC_INFO_ROBO53118 |\
                                     SOC_INFO_ROBO53125 | SOC_INFO_ROBO53128 |\
                                     SOC_INFO_ROBO53128V)))
...
#define PORT_DUALMODID_VALID(_u_, _p_) \
         if ((NUM_MODID(_u_) > 1) && (_p_ > 31)) {return SOC_E_PORT;}       
...
#define PG4X_BLOCK(unit)                (SOC_INFO(unit).pg4x_block)
#define PG4Y_BLOCK(unit)                (SOC_INFO(unit).pg4y_block)
#define PG5X_BLOCK(unit)                (SOC_INFO(unit).pg5x_block)
#define PG5Y_BLOCK(unit)                (SOC_INFO(unit).pg5y_block)
...
#define SOC_INFO_ROBO53280          0x40000        /* 53280 */
#define SOC_INFO_ROBO53280_B0   0x20000         /* ThunderBolt B0 */
#define SOC_INFO_ROBO53101          0x10000        /* 53101 */
#define SOC_INFO_ROBO53125          0x8000        /* 53125 */
#define SOC_INFO_ROBO53128          0x4000        /* 53128 */
#define SOC_INFO_ROBO53128V          0x2000        /* 53128V */
#define SOC_INFO_ROBO      	(SOC_INFO_ROBO5324 | \
    ...
    SOC_INFO_ROBO53280 | SOC_INFO_ROBO53280_B0 |SOC_INFO_ROBO53101 |\
    SOC_INFO_ROBO53125 |SOC_INFO_ROBO53128 | SOC_INFO_ROBO53128V)
        ...
        int             pg4x_block;             /* PORT_GROUP4_X block (TD) */
        int             pg4y_block;             /* PORT_GROUP4_Y block (TD) */
        int             pg5x_block;             /* PORT_GROUP5_X block (TD) */
        int             pg5y_block;             /* PORT_GROUP5_Y block (TD) */
        ...
        int             il_block[2];            /* Interlaken blocks */
