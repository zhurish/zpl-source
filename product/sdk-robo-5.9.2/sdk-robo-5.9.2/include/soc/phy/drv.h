...
typedef struct phy_driver_s {
    ...
    int  (*pd_timesync_config_set)(int, soc_port_t, soc_port_timesync_config_t *);
    int  (*pd_timesync_config_get)(int, soc_port_t, soc_port_timesync_config_t *);
    int  (*pd_timesync_control_set)(int, soc_port_t, soc_port_control_timesync_t, uint64);
    int  (*pd_timesync_control_get)(int, soc_port_t, soc_port_control_timesync_t, uint64 *);
