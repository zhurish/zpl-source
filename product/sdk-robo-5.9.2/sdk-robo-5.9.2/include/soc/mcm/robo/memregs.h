 ...
 *
 * $Id: memregs.h,v 1.47 Broadcom SDK $
...
MEM_ENTRY(cfp_data_mask_entry_t, 64);
...
#define REG_READ_PN_PCP2TCr(unit, idx, rvp) \
	ROBO_REG_READ(unit, PN_PCP2TCr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_PN_PCP2TCr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, PN_PCP2TCr, REG_PORT_ANY, idx, rv)
...
#define REG_READ_PORT7_RGMII_TIME_DLY_GPr(unit, port, rvp) \
	ROBO_REG_READ(unit, PORT7_RGMII_TIME_DLY_GPr, port, 0, rvp)
#define REG_WRITE_PORT7_RGMII_TIME_DLY_GPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, PORT7_RGMII_TIME_DLY_GPr, port, 0, rv)
...
#define REG_READ_RESE_C4_BW_CNTLr(unit, idx, rvp) \
	ROBO_REG_READ(unit, RESE_C4_BW_CNTLr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_RESE_C4_BW_CNTLr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, RESE_C4_BW_CNTLr, REG_PORT_ANY, idx, rv)

#define REG_READ_RESE_C5_BW_CNTLr(unit, idx, rvp) \
	ROBO_REG_READ(unit, RESE_C5_BW_CNTLr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_RESE_C5_BW_CNTLr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, RESE_C5_BW_CNTLr, REG_PORT_ANY, idx, rv)

#define REG_READ_RESE_EGRESS_TM_STAMPr(unit, idx, rvp) \
	ROBO_REG_READ(unit, RESE_EGRESS_TM_STAMPr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_RESE_EGRESS_TM_STAMPr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, RESE_EGRESS_TM_STAMPr, REG_PORT_ANY, idx, rv)
