/*
 * $Id: counter.h,v 1.29 Broadcom SDK $
...
extern int soc_robo_custom_dbg_cntr_set(int unit, uint32 type, soc_reg_t ctr_reg);
extern int soc_robo_custom_dbg_cntr_get(int unit, uint32 type, soc_reg_t * ctr_reg);
