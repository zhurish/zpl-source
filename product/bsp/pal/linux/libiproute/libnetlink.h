...
#define  IFLA_PROP_LIST __IFLA_MAX
#define  IFLA_ALT_IFNAME	__IFLA_MAX+1/* Alternative ifname */
#define  IFLA_PERM_ADDRESS	__IFLA_MAX+2
#define  IFLA_PROTO_DOWN_REASON	__IFLA_MAX+3
#undef __IFLA_MAX
#define  __IFLA_MAX	IFLA_PROTO_DOWN_REASON+1
...
int rtnl_set_strict_dump(struct rtnl_handle *rth);
